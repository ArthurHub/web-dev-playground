...
const $68e5fd8c1fe4e8a4$var$push_to_array = function(arr, value_or_array) {
    $68e5fd8c1fe4e8a4$var$push.apply(arr, $68e5fd8c1fe4e8a4$var$is_array(value_or_array) ? value_or_array : [
        value_or_array
    ]);
};
...
function $68e5fd8c1fe4e8a4$var$inner_stringify(object, prefix, generateArrayPrefix, commaRoundTrip, allowEmptyArrays, strictNullHandling, skipNulls, encodeDotInKeys, encoder, filter, sort, allowDots, serializeDate, format, formatter, encodeValuesOnly, charset, sideChannel) {
    let obj = object;
    ...
    else if (generateArrayPrefix === "comma" && $68e5fd8c1fe4e8a4$var$is_array(obj)) obj = (0, $krGCk.maybe_map)(obj, function(value) {
        if (value instanceof Date) return serializeDate?.(value);
        return value;
    });
    if (obj === null) {
        if (strictNullHandling) return encoder && !encodeValuesOnly ? // @ts-expect-error
        encoder(prefix, $68e5fd8c1fe4e8a4$var$defaults.encoder, charset, "key", format) : prefix;
        obj = "";
    }
    if ($68e5fd8c1fe4e8a4$var$is_non_nullish_primitive(obj) || (0, $krGCk.is_buffer)(obj)) {
        if (encoder) {
            const key_value = encodeValuesOnly ? prefix : encoder(prefix, $68e5fd8c1fe4e8a4$var$defaults.encoder, charset, "key", format);
            return [
                formatter?.(key_value) + "=" + // @ts-expect-error
                formatter?.(encoder(obj, $68e5fd8c1fe4e8a4$var$defaults.encoder, charset, "value", format))
            ];
        }
        return [
    ...
    const adjusted_prefix = commaRoundTrip && $68e5fd8c1fe4e8a4$var$is_array(obj) && obj.length === 1 ? encoded_prefix + "[]" : encoded_prefix;
    if (allowEmptyArrays && $68e5fd8c1fe4e8a4$var$is_array(obj) && obj.length === 0) return adjusted_prefix + "[]";
    for(let j = 0; j < obj_keys.length; ++j){
        ...
        const key_prefix = $68e5fd8c1fe4e8a4$var$is_array(obj) ? typeof generateArrayPrefix === "function" ? generateArrayPrefix(adjusted_prefix, encoded_key) : adjusted_prefix : adjusted_prefix + (allowDots ? "." + encoded_key : "[" + encoded_key + "]");
        sideChannel.set(object, step);
        const valueSideChannel = new WeakMap();
        valueSideChannel.set($68e5fd8c1fe4e8a4$var$sentinel, sideChannel);
        $68e5fd8c1fe4e8a4$var$push_to_array(values, $68e5fd8c1fe4e8a4$var$inner_stringify(value, key_prefix, generateArrayPrefix, commaRoundTrip, allowEmptyArrays, strictNullHandling, skipNulls, encodeDotInKeys, // @ts-ignore
        generateArrayPrefix === "comma" && encodeValuesOnly && $68e5fd8c1fe4e8a4$var$is_array(obj) ? null : encoder, filter, sort, allowDots, serializeDate, format, formatter, encodeValuesOnly, charset, valueSideChannel));
    }
    return values;
}
function $68e5fd8c1fe4e8a4$var$normalize_stringify_options(opts = $68e5fd8c1fe4e8a4$var$defaults) {
    ...
    if (typeof opts.format !== "undefined") {
        if (!$68e5fd8c1fe4e8a4$var$has.call($bgdqL.formatters, opts.format)) throw new TypeError("Unknown format option provided.");
        format = opts.format;
    }
    const formatter = $bgdqL.formatters[format];
    let filter = $68e5fd8c1fe4e8a4$var$defaults.filter;
    if (typeof opts.filter === "function" || $68e5fd8c1fe4e8a4$var$is_array(opts.filter)) filter = opts.filter;
    let arrayFormat;
    if (opts.arrayFormat && opts.arrayFormat in $68e5fd8c1fe4e8a4$var$array_prefix_generators) arrayFormat = opts.arrayFormat;
    else if ("indices" in opts) arrayFormat = opts.indices ? "indices" : "repeat";
    else arrayFormat = $68e5fd8c1fe4e8a4$var$defaults.arrayFormat;
    if ("commaRoundTrip" in opts && typeof opts.commaRoundTrip !== "boolean") throw new TypeError("`commaRoundTrip` must be a boolean, or absent");
    const allowDots = typeof opts.allowDots === "undefined" ? !!opts.encodeDotInKeys === true ? true : $68e5fd8c1fe4e8a4$var$defaults.allowDots : !!opts.allowDots;
    return {
        addQueryPrefix: typeof opts.addQueryPrefix === "boolean" ? opts.addQueryPrefix : $68e5fd8c1fe4e8a4$var$defaults.addQueryPrefix,
        // @ts-ignore
        allowDots: allowDots,
        allowEmptyArrays: typeof opts.allowEmptyArrays === "boolean" ? !!opts.allowEmptyArrays : $68e5fd8c1fe4e8a4$var$defaults.allowEmptyArrays,
        arrayFormat: arrayFormat,
        charset: charset,
        charsetSentinel: typeof opts.charsetSentinel === "boolean" ? opts.charsetSentinel : $68e5fd8c1fe4e8a4$var$defaults.charsetSentinel,
        commaRoundTrip: !!opts.commaRoundTrip,
        delimiter: typeof opts.delimiter === "undefined" ? $68e5fd8c1fe4e8a4$var$defaults.delimiter : opts.delimiter,
        encode: typeof opts.encode === "boolean" ? opts.encode : $68e5fd8c1fe4e8a4$var$defaults.encode,
        encodeDotInKeys: typeof opts.encodeDotInKeys === "boolean" ? opts.encodeDotInKeys : $68e5fd8c1fe4e8a4$var$defaults.encodeDotInKeys,
        encoder: typeof opts.encoder === "function" ? opts.encoder : $68e5fd8c1fe4e8a4$var$defaults.encoder,
        encodeValuesOnly: typeof opts.encodeValuesOnly === "boolean" ? opts.encodeValuesOnly : $68e5fd8c1fe4e8a4$var$defaults.encodeValuesOnly,
        filter: filter,
        format: format,
        formatter: formatter,
        serializeDate: typeof opts.serializeDate === "function" ? opts.serializeDate : $68e5fd8c1fe4e8a4$var$defaults.serializeDate,
        skipNulls: typeof opts.skipNulls === "boolean" ? opts.skipNulls : $68e5fd8c1fe4e8a4$var$defaults.skipNulls,
        // @ts-ignore
        sort: typeof opts.sort === "function" ? opts.sort : null,
        strictNullHandling: typeof opts.strictNullHandling === "boolean" ? opts.strictNullHandling : $68e5fd8c1fe4e8a4$var$defaults.strictNullHandling
    };
}
function $68e5fd8c1fe4e8a4$var$stringify(object, opts = {}) {
    ...
    for(let i = 0; i < obj_keys.length; ++i){
        ...
        $68e5fd8c1fe4e8a4$var$push_to_array(keys, $68e5fd8c1fe4e8a4$var$inner_stringify(obj[key], key, // @ts-expect-error
...
function $ee2763247a96beca$var$merge(target, source, options = {}) {
    ...
    if (typeof source !== "object") {
        if ($ee2763247a96beca$var$is_array(target)) target.push(source);
            ...
            if (options && (options.plainObjects || options.allowPrototypes) || !$ee2763247a96beca$var$has.call(Object.prototype, source)) target[source] = true;
        } else return [
            target,
            source
        ];
    ...
    if ($ee2763247a96beca$var$is_array(target) && !$ee2763247a96beca$var$is_array(source)) // @ts-ignore
    ...
    if ($ee2763247a96beca$var$is_array(target) && $ee2763247a96beca$var$is_array(source)) {
        source.forEach(function(item, i) {
            if ($ee2763247a96beca$var$has.call(target, i)) {
                ...
                if (targetItem && typeof targetItem === "object" && item && typeof item === "object") target[i] = $ee2763247a96beca$var$merge(targetItem, item, options);
    ...
    return Object.keys(source).reduce(function(acc, key) {
        ...
        if ($ee2763247a96beca$var$has.call(acc, key)) acc[key] = $ee2763247a96beca$var$merge(acc[key], value, options);
        else acc[key] = value;
        return acc;
    }, mergeTarget);
}
...
const $ee2763247a96beca$var$encode = (str, _defaultEncoder, charset, _kind, format)=>{
    ...
    for(let j = 0; j < string.length; j += $ee2763247a96beca$var$limit){
        const segment = string.length >= $ee2763247a96beca$var$limit ? string.slice(j, j + $ee2763247a96beca$var$limit) : string;
        const arr = [];
        for(let i = 0; i < segment.length; ++i){
            ...
            if (c < 0x800) {
                arr[arr.length] = $ee2763247a96beca$var$hex_table[0xc0 | c >> 6] + $ee2763247a96beca$var$hex_table[0x80 | c & 0x3f];
                continue;
            }
            if (c < 0xd800 || c >= 0xe000) {
                arr[arr.length] = $ee2763247a96beca$var$hex_table[0xe0 | c >> 12] + $ee2763247a96beca$var$hex_table[0x80 | c >> 6 & 0x3f] + $ee2763247a96beca$var$hex_table[0x80 | c & 0x3f];
                continue;
            }
            i += 1;
            c = 0x10000 + ((c & 0x3ff) << 10 | segment.charCodeAt(i) & 0x3ff);
            arr[arr.length] = $ee2763247a96beca$var$hex_table[0xf0 | c >> 18] + $ee2763247a96beca$var$hex_table[0x80 | c >> 12 & 0x3f] + $ee2763247a96beca$var$hex_table[0x80 | c >> 6 & 0x3f] + $ee2763247a96beca$var$hex_table[0x80 | c & 0x3f];
        }
        out += arr.join("");
    }
    return out;
...
"use strict";
var $185bf234c27985d4$var$__classPrivateFieldSet = module.exports && module.exports.__classPrivateFieldSet || function(receiver, state, value, kind, f) {
    if (kind === "m") throw new TypeError("Private method is not writable");
    if (kind === "a" && !f) throw new TypeError("Private accessor was defined without a setter");
    if (typeof state === "function" ? receiver !== state || !f : !state.has(receiver)) throw new TypeError("Cannot write private member to an object whose class did not declare it");
    return kind === "a" ? f.call(receiver, value) : f ? f.value = value : state.set(receiver, value), value;
};
var $185bf234c27985d4$var$__classPrivateFieldGet = module.exports && module.exports.__classPrivateFieldGet || function(receiver, state, kind, f) {
...
async function $185bf234c27985d4$var$defaultParseResponse(props) {
    ...
    if (props.options.stream) {
        $185bf234c27985d4$var$debug("response", response.status, response.url, response.headers, response.body);
    ...
    if (isJSON) {
        ...
        $185bf234c27985d4$var$debug("response", response.status, response.url, response.headers, json);
 ...
 */ class $185bf234c27985d4$var$APIPromise extends Promise {
    ...
    _thenUnwrap(transform) {
        return new $185bf234c27985d4$var$APIPromise(this.responsePromise, async (props)=>$185bf234c27985d4$var$_addRequestID(transform(await this.parseResponse(props), props), props.response));
    }
    /**
...
class $185bf234c27985d4$var$APIClient {
    ...
    methodRequest(method, path, opts) {
        return this.request(Promise.resolve(opts).then(async (opts)=>{
            const body = opts && (0, $lsd5d.isBlobLike)(opts?.body) ? new DataView(await opts.body.arrayBuffer()) : opts?.body instanceof DataView ? opts.body : opts?.body instanceof ArrayBuffer ? new DataView(opts.body) : opts && ArrayBuffer.isView(opts?.body) ? new DataView(opts.body.buffer) : opts?.body;
            return {
                method: method,
                path: path,
                ...opts,
    ...
    buildRequest(options, { retryCount: retryCount = 0 } = {}) {
        ...
        const body = ArrayBuffer.isView(options.body) || options.__binaryRequest && typeof options.body === "string" ? options.body : (0, $lsd5d.isMultipartBody)(options.body) ? options.body.body : options.body ? JSON.stringify(options.body, null, 2) : null;
        const contentLength = this.calculateContentLength(body);
        const url = this.buildURL(path, query);
        if ("timeout" in options) $185bf234c27985d4$var$validatePositiveInteger("timeout", options.timeout);
    ...
    buildHeaders({ options: options, headers: headers, contentLength: contentLength, retryCount: retryCount }) {
        ...
        if ((0, $lsd5d.isMultipartBody)(options.body) && $7fnIa.kind !== "node") delete reqHeaders["content-type"];
        // Don't set the retry count header if it was already set or removed through default headers or by the
        // caller. We check `defaultHeaders` and `headers`, which can contain nulls, instead of `reqHeaders` to
        // account for the removal case.
        if ((0, module.exports.getHeader)(defaultHeaders, "x-stainless-retry-count") === undefined && (0, module.exports.getHeader)(headers, "x-stainless-retry-count") === undefined) reqHeaders["x-stainless-retry-count"] = String(retryCount);
    ...
    async makeRequest(optionsInput, retriesRemaining) {
        ...
        if (!response.ok) {
            if (retriesRemaining && this.shouldRetry(response)) {
                ...
                $185bf234c27985d4$var$debug(`response (error; ${retryMessage})`, response.status, url, responseHeaders);
            ...
            $185bf234c27985d4$var$debug(`response (error; ${retryMessage})`, response.status, url, responseHeaders, errMessage);
    ...
    buildURL(path, query) {
        const url = $185bf234c27985d4$var$isAbsoluteURL(path) ? new URL(path) : new URL(this.baseURL + (this.baseURL.endsWith("/") && path.startsWith("/") ? path.slice(1) : path));
        const defaultQuery = this.defaultQuery();
        if (!$185bf234c27985d4$var$isEmptyObj(defaultQuery)) query = {
            ...defaultQuery,
            ...query
        };
    ...
    stringifyQuery(query) {
        return Object.entries(query).filter(([_, value])=>typeof value !== "undefined").map(([key, value])=>{
            ...
            throw new $eK9Mf.OpenAIError(`Cannot stringify type ${typeof value}; Expected string, number, boolean, or null. If you need to pass nested query parameters, you can manually encode them, e.g. { query: { 'foo[key1]': value1, 'foo[key2]': value2 } }, and please open a GitHub issue requesting better support for your use case.`);
        }).join("&");
    }
...
class $185bf234c27985d4$var$AbstractPage {
    constructor(client, response, body, options){
        ...
        $185bf234c27985d4$var$__classPrivateFieldSet(this, $185bf234c27985d4$var$_AbstractPage_client, client, "f");
    ...
    async getNextPage() {
        ...
        if (!nextInfo) throw new $eK9Mf.OpenAIError("No next page expected; please check `.hasNextPage()` before calling `.getNextPage()`.");
        const nextOptions = {
            ...this.options
        };
        ...
        return await $185bf234c27985d4$var$__classPrivateFieldGet(this, $185bf234c27985d4$var$_AbstractPage_client, "f").requestAPIList(this.constructor, nextOptions);
    }
    async *iterPages() {
    ...
    async *[($185bf234c27985d4$var$_AbstractPage_client = new WeakMap(), Symbol.asyncIterator)]() {
 ...
 */ class $185bf234c27985d4$var$PagePromise extends $185bf234c27985d4$var$APIPromise {
    constructor(client, request, Page){
        super(request, async (props)=>new Page(client, props.response, await $185bf234c27985d4$var$defaultParseResponse(props), props.options));
    }
    /**
...
const $185bf234c27985d4$var$isRequestOptions = (obj)=>{
    return typeof obj === "object" && obj !== null && !$185bf234c27985d4$var$isEmptyObj(obj) && Object.keys(obj).every((k)=>$185bf234c27985d4$var$hasOwn($185bf234c27985d4$var$requestOptionsKeys, k));
};
...
const $185bf234c27985d4$var$getPlatformHeaders = ()=>{
    return $185bf234c27985d4$var$_platformHeaders ?? ($185bf234c27985d4$var$_platformHeaders = $185bf234c27985d4$var$getPlatformProperties());
};
...
const $185bf234c27985d4$var$validatePositiveInteger = (name, n)=>{
    if (typeof n !== "number" || !Number.isInteger(n)) throw new $eK9Mf.OpenAIError(`${name} must be an integer`);
...
const $185bf234c27985d4$var$ensurePresent = (value)=>{
    if (value == null) throw new $eK9Mf.OpenAIError(`Expected a value to be given but received ${value} instead.`);
    return value;
};
 ...
 */ const $185bf234c27985d4$var$toBase64 = (str)=>{
    ...
    throw new $eK9Mf.OpenAIError("Cannot generate b64 string; Expected `Buffer` or `btoa` to be defined");
};
            ...
            try {
                for await (const sse of $6f83ce5c32768f8f$var$_iterSSEMessages(response, controller)){
                    ...
                    if (sse.event === null) {
                        ...
                        if (data && data.error) throw new $eK9Mf.APIError(undefined, data.error, undefined, undefined);
                        yield data;
                    } else {
                        let data;
                        try {
                        ...
                        if (sse.event == "error") throw new $eK9Mf.APIError(undefined, data.error, data.message, undefined);
                        yield {
                            event: sse.event,
                            data: data
                        };
...
async function* $6f83ce5c32768f8f$var$_iterSSEMessages(response, controller) {
    ...
    for await (const sseChunk of $6f83ce5c32768f8f$var$iterSSEChunks(iter))for (const line of lineDecoder.decode(sseChunk)){
...
/** This is an internal helper function that's just used for testing */ function $6f83ce5c32768f8f$var$_decodeChunks(chunks) {
...
if (!$fqfNJ.kind) $fqfNJ.setShims($ecrQB.getRuntime(), {
    auto: true
});
for (const property of Object.keys($fqfNJ))Object.defineProperty(module.exports, property, {
    get () {
...
function $b3a58a79e1c7ffbc$var$setShims(shims, options = {
    auto: false
}) {
...
"use strict";
var $a567c997d0b8668f$var$__createBinding = module.exports && module.exports.__createBinding || (Object.create ? function(o, m, k, k2) {
    if (k2 === undefined) k2 = k;
    var desc = Object.getOwnPropertyDescriptor(m, k);
    if (!desc || ("get" in desc ? !m.__esModule : desc.writable || desc.configurable)) desc = {
        enumerable: true,
...
var $a567c997d0b8668f$var$__exportStar = module.exports && module.exports.__exportStar || function(m, exports1) {
    for(var p in m)if (p !== "default" && !Object.prototype.hasOwnProperty.call(exports1, p)) $a567c997d0b8668f$var$__createBinding(exports1, m, p);
};
Object.defineProperty(module.exports, "__esModule", {
    value: true
});
...
class $abbcf21fd6ad6572$var$APIError extends $abbcf21fd6ad6572$var$OpenAIError {
    ...
    static generate(status, errorResponse, message, headers) {
        if (!status) return new $abbcf21fd6ad6572$var$APIConnectionError({
            message: message,
            cause: (0, $25F7z.castToError)(errorResponse)
        });
        const error = errorResponse?.["error"];
        if (status === 400) return new $abbcf21fd6ad6572$var$BadRequestError(status, error, message, headers);
        if (status === 401) return new $abbcf21fd6ad6572$var$AuthenticationError(status, error, message, headers);
        if (status === 403) return new $abbcf21fd6ad6572$var$PermissionDeniedError(status, error, message, headers);
        if (status === 404) return new $abbcf21fd6ad6572$var$NotFoundError(status, error, message, headers);
        if (status === 409) return new $abbcf21fd6ad6572$var$ConflictError(status, error, message, headers);
        if (status === 422) return new $abbcf21fd6ad6572$var$UnprocessableEntityError(status, error, message, headers);
        if (status === 429) return new $abbcf21fd6ad6572$var$RateLimitError(status, error, message, headers);
        if (status >= 500) return new $abbcf21fd6ad6572$var$InternalServerError(status, error, message, headers);
...
module.exports.ContentFilterFinishReasonError = $abbcf21fd6ad6572$var$ContentFilterFinishReasonError;
 ...
 */ class $f7e83bd86ab1c14e$var$LineDecoder {
    ...
    decode(chunk) {
        ...
        if (!text) return [];
        const trailingNewline = $f7e83bd86ab1c14e$var$LineDecoder.NEWLINE_CHARS.has(text[text.length - 1] || "");
    ...
    decodeText(bytes) {
        ...
        if (typeof Buffer !== "undefined") {
            ...
            throw new $eK9Mf.OpenAIError(`Unexpected: received non-Uint8Array (${bytes.constructor.name}) stream chunk in an environment with a global "Buffer" defined, which this library assumes to be Node. Please report this error.`);
        }
        // Browser
        if (typeof TextDecoder !== "undefined") {
            ...
            throw new $eK9Mf.OpenAIError(`Unexpected: received non-Uint8Array/ArrayBuffer (${bytes.constructor.name}) in a web platform. Please report this error.`);
        }
        throw new $eK9Mf.OpenAIError(`Unexpected: neither Buffer nor TextDecoder are available as globals. Please report this error.`);
    }
    flush() {
...
const $f9e65c87ffd0dc4e$var$isResponseLike = (value)=>value != null && typeof value === "object" && typeof value.url === "string" && typeof value.blob === "function";
module.exports.isResponseLike = $f9e65c87ffd0dc4e$var$isResponseLike;
const $f9e65c87ffd0dc4e$var$isFileLike = (value)=>value != null && typeof value === "object" && typeof value.name === "string" && typeof value.lastModified === "number" && (0, module.exports.isBlobLike)(value);
module.exports.isFileLike = $f9e65c87ffd0dc4e$var$isFileLike;
/**
 * The BlobLike type omits arrayBuffer() because @types/node-fetch@^2.6.4 lacks it; but this check
 * adds the arrayBuffer() method type because it is available and used at runtime
 */ const $f9e65c87ffd0dc4e$var$isBlobLike = (value)=>value != null && typeof value === "object" && typeof value.size === "number" && typeof value.type === "string" && typeof value.text === "function" && typeof value.slice === "function" && typeof value.arrayBuffer === "function";
module.exports.isBlobLike = $f9e65c87ffd0dc4e$var$isBlobLike;
const $f9e65c87ffd0dc4e$var$isUploadable = (value)=>{
    return (0, module.exports.isFileLike)(value) || (0, module.exports.isResponseLike)(value) || (0, $7fnIa.isFsReadStream)(value);
};
...
async function $f9e65c87ffd0dc4e$var$getBytes(value) {
    ...
    else if ($f9e65c87ffd0dc4e$var$isAsyncIterableIterator(value) // includes Readable, ReadableStream, etc.
    ) for await (const chunk of value)parts.push(chunk); // TODO, consider validating?
    else throw new Error(`Unexpected data type: ${typeof value}; constructor: ${value?.constructor?.name}; props: ${$f9e65c87ffd0dc4e$var$propsForError(value)}`);
    return parts;
}
...
function $f9e65c87ffd0dc4e$var$getName(value) {
    return $f9e65c87ffd0dc4e$var$getStringFromMaybeBuffer(value.name) || $f9e65c87ffd0dc4e$var$getStringFromMaybeBuffer(value.filename) || // For fs.ReadStream
...
const $f9e65c87ffd0dc4e$var$isAsyncIterableIterator = (value)=>value != null && typeof value === "object" && typeof value[Symbol.asyncIterator] === "function";
const $f9e65c87ffd0dc4e$var$isMultipartBody = (body)=>body && typeof body === "object" && body.body && body[Symbol.toStringTag] === "MultipartBody";
...
module.exports.maybeMultipartFormRequestOptions = $f9e65c87ffd0dc4e$var$maybeMultipartFormRequestOptions;
...
const $f9e65c87ffd0dc4e$var$createForm = async (body)=>{
    ...
    await Promise.all(Object.entries(body || {}).map(([key, value])=>$f9e65c87ffd0dc4e$var$addFormValue(form, key, value)));
    return form;
};
...
const $f9e65c87ffd0dc4e$var$addFormValue = async (form, key, value)=>{
    ...
    } else if (Array.isArray(value)) await Promise.all(value.map((entry)=>$f9e65c87ffd0dc4e$var$addFormValue(form, key + "[]", entry)));
    else if (typeof value === "object") await Promise.all(Object.entries(value).map(([name, prop])=>$f9e65c87ffd0dc4e$var$addFormValue(form, `${key}[${name}]`, prop)));
...
"use strict";
// File generated from our OpenAPI spec by Stainless. See CONTRIBUTING.md for details.
var $6bb062e9c1d33a3f$var$__createBinding = module.exports && module.exports.__createBinding || (Object.create ? function(o, m, k, k2) {
    if (k2 === undefined) k2 = k;
    var desc = Object.getOwnPropertyDescriptor(m, k);
    if (!desc || ("get" in desc ? !m.__esModule : desc.writable || desc.configurable)) desc = {
        enumerable: true,
...
var $6bb062e9c1d33a3f$var$__exportStar = module.exports && module.exports.__exportStar || function(m, exports1) {
    for(var p in m)if (p !== "default" && !Object.prototype.hasOwnProperty.call(exports1, p)) $6bb062e9c1d33a3f$var$__createBinding(exports1, m, p);
};
Object.defineProperty(module.exports, "__esModule", {
    value: true
});
...
"use strict";
// File generated from our OpenAPI spec by Stainless. See CONTRIBUTING.md for details.
var $137f2907597ebbde$var$__createBinding = module.exports && module.exports.__createBinding || (Object.create ? function(o, m, k, k2) {
    if (k2 === undefined) k2 = k;
    var desc = Object.getOwnPropertyDescriptor(m, k);
    if (!desc || ("get" in desc ? !m.__esModule : desc.writable || desc.configurable)) desc = {
        enumerable: true,
...
var $137f2907597ebbde$var$__setModuleDefault = module.exports && module.exports.__setModuleDefault || (Object.create ? function(o, v) {
    Object.defineProperty(o, "default", {
        enumerable: true,
        value: v
    });
...
var $137f2907597ebbde$var$__importStar = module.exports && module.exports.__importStar || function(mod) {
    if (mod && mod.__esModule) return mod;
    var result = {};
    if (mod != null) {
        for(var k in mod)if (k !== "default" && Object.prototype.hasOwnProperty.call(mod, k)) $137f2907597ebbde$var$__createBinding(result, mod, k);
    }
...
const $137f2907597ebbde$var$CompletionsAPI = $137f2907597ebbde$var$__importStar((parcelRequire("60jra")));
...
"use strict";
// File generated from our OpenAPI spec by Stainless. See CONTRIBUTING.md for details.
var $24bf40cc6abf2d9f$var$__createBinding = module.exports && module.exports.__createBinding || (Object.create ? function(o, m, k, k2) {
    if (k2 === undefined) k2 = k;
    var desc = Object.getOwnPropertyDescriptor(m, k);
    if (!desc || ("get" in desc ? !m.__esModule : desc.writable || desc.configurable)) desc = {
        enumerable: true,
...
var $24bf40cc6abf2d9f$var$__setModuleDefault = module.exports && module.exports.__setModuleDefault || (Object.create ? function(o, v) {
    Object.defineProperty(o, "default", {
        enumerable: true,
        value: v
    });
...
var $24bf40cc6abf2d9f$var$__importStar = module.exports && module.exports.__importStar || function(mod) {
    if (mod && mod.__esModule) return mod;
    var result = {};
    if (mod != null) {
        for(var k in mod)if (k !== "default" && Object.prototype.hasOwnProperty.call(mod, k)) $24bf40cc6abf2d9f$var$__createBinding(result, mod, k);
    }
...
const $24bf40cc6abf2d9f$var$SpeechAPI = $24bf40cc6abf2d9f$var$__importStar((parcelRequire("4Zcp7")));


const $24bf40cc6abf2d9f$var$TranscriptionsAPI = $24bf40cc6abf2d9f$var$__importStar((parcelRequire("5emD7")));


const $24bf40cc6abf2d9f$var$TranslationsAPI = $24bf40cc6abf2d9f$var$__importStar((parcelRequire("loHq0")));

class $24bf40cc6abf2d9f$var$Audio extends $dQuSh.APIResource {
    constructor(){
        super(...arguments);
        this.transcriptions = new $24bf40cc6abf2d9f$var$TranscriptionsAPI.Transcriptions(this._client);
...
"use strict";
// File generated from our OpenAPI spec by Stainless. See CONTRIBUTING.md for details.
var $3cefd061c55e16c8$var$__createBinding = module.exports && module.exports.__createBinding || (Object.create ? function(o, m, k, k2) {
    if (k2 === undefined) k2 = k;
    var desc = Object.getOwnPropertyDescriptor(m, k);
    if (!desc || ("get" in desc ? !m.__esModule : desc.writable || desc.configurable)) desc = {
        enumerable: true,
...
var $3cefd061c55e16c8$var$__setModuleDefault = module.exports && module.exports.__setModuleDefault || (Object.create ? function(o, v) {
    Object.defineProperty(o, "default", {
        enumerable: true,
        value: v
    });
...
var $3cefd061c55e16c8$var$__importStar = module.exports && module.exports.__importStar || function(mod) {
    if (mod && mod.__esModule) return mod;
    var result = {};
    if (mod != null) {
        for(var k in mod)if (k !== "default" && Object.prototype.hasOwnProperty.call(mod, k)) $3cefd061c55e16c8$var$__createBinding(result, mod, k);
    }
...
class $3cefd061c55e16c8$var$Transcriptions extends $dQuSh.APIResource {
    create(body, options) {
        return this._client.post("/audio/transcriptions", $3cefd061c55e16c8$var$Core.multipartFormRequestOptions({
            body: body,
            ...options
        }));
    }
...
"use strict";
// File generated from our OpenAPI spec by Stainless. See CONTRIBUTING.md for details.
var $f93d84deb5b6abb7$var$__createBinding = module.exports && module.exports.__createBinding || (Object.create ? function(o, m, k, k2) {
    if (k2 === undefined) k2 = k;
    var desc = Object.getOwnPropertyDescriptor(m, k);
    if (!desc || ("get" in desc ? !m.__esModule : desc.writable || desc.configurable)) desc = {
        enumerable: true,
...
var $f93d84deb5b6abb7$var$__setModuleDefault = module.exports && module.exports.__setModuleDefault || (Object.create ? function(o, v) {
    Object.defineProperty(o, "default", {
        enumerable: true,
        value: v
    });
...
var $f93d84deb5b6abb7$var$__importStar = module.exports && module.exports.__importStar || function(mod) {
    if (mod && mod.__esModule) return mod;
    var result = {};
    if (mod != null) {
        for(var k in mod)if (k !== "default" && Object.prototype.hasOwnProperty.call(mod, k)) $f93d84deb5b6abb7$var$__createBinding(result, mod, k);
    }
...
class $f93d84deb5b6abb7$var$Translations extends $dQuSh.APIResource {
    create(body, options) {
        return this._client.post("/audio/translations", $f93d84deb5b6abb7$var$Core.multipartFormRequestOptions({
            body: body,
            ...options
        }));
    }
...
"use strict";
// File generated from our OpenAPI spec by Stainless. See CONTRIBUTING.md for details.
var $2fb11204f79f3093$var$__createBinding = module.exports && module.exports.__createBinding || (Object.create ? function(o, m, k, k2) {
    if (k2 === undefined) k2 = k;
    var desc = Object.getOwnPropertyDescriptor(m, k);
    if (!desc || ("get" in desc ? !m.__esModule : desc.writable || desc.configurable)) desc = {
        enumerable: true,
...
var $2fb11204f79f3093$var$__setModuleDefault = module.exports && module.exports.__setModuleDefault || (Object.create ? function(o, v) {
    Object.defineProperty(o, "default", {
        enumerable: true,
        value: v
    });
...
var $2fb11204f79f3093$var$__importStar = module.exports && module.exports.__importStar || function(mod) {
    if (mod && mod.__esModule) return mod;
    var result = {};
    if (mod != null) {
        for(var k in mod)if (k !== "default" && Object.prototype.hasOwnProperty.call(mod, k)) $2fb11204f79f3093$var$__createBinding(result, mod, k);
    }
...
const $2fb11204f79f3093$var$AssistantsAPI = $2fb11204f79f3093$var$__importStar((parcelRequire("8H2PX")));

const $2fb11204f79f3093$var$ChatAPI = $2fb11204f79f3093$var$__importStar((parcelRequire("dytP0")));


const $2fb11204f79f3093$var$ThreadsAPI = $2fb11204f79f3093$var$__importStar((parcelRequire("4UuAG")));


const $2fb11204f79f3093$var$VectorStoresAPI = $2fb11204f79f3093$var$__importStar((parcelRequire("3XMqz")));
...
"use strict";
// File generated from our OpenAPI spec by Stainless. See CONTRIBUTING.md for details.
var $028bf605722fc52c$var$__createBinding = module.exports && module.exports.__createBinding || (Object.create ? function(o, m, k, k2) {
    if (k2 === undefined) k2 = k;
    var desc = Object.getOwnPropertyDescriptor(m, k);
    if (!desc || ("get" in desc ? !m.__esModule : desc.writable || desc.configurable)) desc = {
        enumerable: true,
...
var $028bf605722fc52c$var$__setModuleDefault = module.exports && module.exports.__setModuleDefault || (Object.create ? function(o, v) {
    Object.defineProperty(o, "default", {
        enumerable: true,
        value: v
    });
...
var $028bf605722fc52c$var$__importStar = module.exports && module.exports.__importStar || function(mod) {
    if (mod && mod.__esModule) return mod;
    var result = {};
    if (mod != null) {
        for(var k in mod)if (k !== "default" && Object.prototype.hasOwnProperty.call(mod, k)) $028bf605722fc52c$var$__createBinding(result, mod, k);
    }
...
const $028bf605722fc52c$var$CompletionsAPI = $028bf605722fc52c$var$__importStar((parcelRequire("2s3lG")));
...
module.exports.Completions = module.exports.ChatCompletionRunner = module.exports.ChatCompletionStream = module.exports.ParsingToolFunction = module.exports.ParsingFunction = module.exports.ChatCompletionStreamingRunner = void 0;
...
class $1c90cb4af26eaf26$var$Completions extends $dQuSh.APIResource {
    ...
    runFunctions(body, options) {
        if (body.stream) return $ajlBJ.ChatCompletionStreamingRunner.runFunctions(this._client, body, options);
        return $30nd9.ChatCompletionRunner.runFunctions(this._client, body, options);
    }
    runTools(body, options) {
        if (body.stream) return $ajlBJ.ChatCompletionStreamingRunner.runTools(this._client, body, options);
...
class $23036067d026c53c$var$ChatCompletionRunner extends $4II4O.AbstractChatCompletionRunner {
    ...
    _addMessage(message, emit = true) {
        ...
        if ((0, $ehgTu.isAssistantMessage)(message) && message.content) this._emit("content", message.content);
    }
}
...
"use strict";
var $36fd7633a39d2452$var$__classPrivateFieldGet = module.exports && module.exports.__classPrivateFieldGet || function(receiver, state, kind, f) {
    if (kind === "a" && !f) throw new TypeError("Private accessor was defined without a getter");
    if (typeof state === "function" ? receiver !== state || !f : !state.has(receiver)) throw new TypeError("Cannot read private member from an object whose class did not declare it");
    return kind === "m" ? f : kind === "a" ? f.call(receiver) : f ? f.value : state.get(receiver);
};
var $36fd7633a39d2452$var$_AbstractChatCompletionRunner_instances, $36fd7633a39d2452$var$_AbstractChatCompletionRunner_getFinalContent, $36fd7633a39d2452$var$_AbstractChatCompletionRunner_getFinalMessage, $36fd7633a39d2452$var$_AbstractChatCompletionRunner_getFinalFunctionCall, $36fd7633a39d2452$var$_AbstractChatCompletionRunner_getFinalFunctionCallResult, $36fd7633a39d2452$var$_AbstractChatCompletionRunner_calculateTotalUsage, $36fd7633a39d2452$var$_AbstractChatCompletionRunner_validateParams, $36fd7633a39d2452$var$_AbstractChatCompletionRunner_stringifyFunctionCallResult;
Object.defineProperty(module.exports, "__esModule", {
    value: true
});
...
class $36fd7633a39d2452$var$AbstractChatCompletionRunner extends $7tW0Y.EventStream {
    ...
    _addMessage(message, emit = true) {
        ...
        if (emit) {
            ...
            if (((0, $ehgTu.isFunctionMessage)(message) || (0, $ehgTu.isToolMessage)(message)) && message.content) // Note, this assumes that {role: 'tool', content: …} is always the result of a call of tool of type=function.
            this._emit("functionCallResult", message.content);
            else if ((0, $ehgTu.isAssistantMessage)(message) && message.function_call) this._emit("functionCall", message.function_call);
     ...
     */ async finalChatCompletion() {
        ...
        if (!completion) throw new $eK9Mf.OpenAIError("stream ended without producing a ChatCompletion");
        return completion;
    }
    /**
     ...
     */ async finalContent() {
        await this.done();
        return $36fd7633a39d2452$var$__classPrivateFieldGet(this, $36fd7633a39d2452$var$_AbstractChatCompletionRunner_instances, "m", $36fd7633a39d2452$var$_AbstractChatCompletionRunner_getFinalContent).call(this);
    }
    /**
     ...
     */ async finalMessage() {
        await this.done();
        return $36fd7633a39d2452$var$__classPrivateFieldGet(this, $36fd7633a39d2452$var$_AbstractChatCompletionRunner_instances, "m", $36fd7633a39d2452$var$_AbstractChatCompletionRunner_getFinalMessage).call(this);
    }
    /**
     ...
     */ async finalFunctionCall() {
        await this.done();
        return $36fd7633a39d2452$var$__classPrivateFieldGet(this, $36fd7633a39d2452$var$_AbstractChatCompletionRunner_instances, "m", $36fd7633a39d2452$var$_AbstractChatCompletionRunner_getFinalFunctionCall).call(this);
    }
    async finalFunctionCallResult() {
        await this.done();
        return $36fd7633a39d2452$var$__classPrivateFieldGet(this, $36fd7633a39d2452$var$_AbstractChatCompletionRunner_instances, "m", $36fd7633a39d2452$var$_AbstractChatCompletionRunner_getFinalFunctionCallResult).call(this);
    }
    async totalUsage() {
        await this.done();
        return $36fd7633a39d2452$var$__classPrivateFieldGet(this, $36fd7633a39d2452$var$_AbstractChatCompletionRunner_instances, "m", $36fd7633a39d2452$var$_AbstractChatCompletionRunner_calculateTotalUsage).call(this);
    }
    allChatCompletions() {
        return [
            ...this._chatCompletions
    ...
    _emitFinal() {
        ...
        const finalMessage = $36fd7633a39d2452$var$__classPrivateFieldGet(this, $36fd7633a39d2452$var$_AbstractChatCompletionRunner_instances, "m", $36fd7633a39d2452$var$_AbstractChatCompletionRunner_getFinalMessage).call(this);
        if (finalMessage) this._emit("finalMessage", finalMessage);
        const finalContent = $36fd7633a39d2452$var$__classPrivateFieldGet(this, $36fd7633a39d2452$var$_AbstractChatCompletionRunner_instances, "m", $36fd7633a39d2452$var$_AbstractChatCompletionRunner_getFinalContent).call(this);
        if (finalContent) this._emit("finalContent", finalContent);
        const finalFunctionCall = $36fd7633a39d2452$var$__classPrivateFieldGet(this, $36fd7633a39d2452$var$_AbstractChatCompletionRunner_instances, "m", $36fd7633a39d2452$var$_AbstractChatCompletionRunner_getFinalFunctionCall).call(this);
        if (finalFunctionCall) this._emit("finalFunctionCall", finalFunctionCall);
        const finalFunctionCallResult = $36fd7633a39d2452$var$__classPrivateFieldGet(this, $36fd7633a39d2452$var$_AbstractChatCompletionRunner_instances, "m", $36fd7633a39d2452$var$_AbstractChatCompletionRunner_getFinalFunctionCallResult).call(this);
        if (finalFunctionCallResult != null) this._emit("finalFunctionCallResult", finalFunctionCallResult);
        if (this._chatCompletions.some((c)=>c.usage)) this._emit("totalUsage", $36fd7633a39d2452$var$__classPrivateFieldGet(this, $36fd7633a39d2452$var$_AbstractChatCompletionRunner_instances, "m", $36fd7633a39d2452$var$_AbstractChatCompletionRunner_calculateTotalUsage).call(this));
    }
    async _createChatCompletion(client, params, options) {
        ...
        $36fd7633a39d2452$var$__classPrivateFieldGet(this, $36fd7633a39d2452$var$_AbstractChatCompletionRunner_instances, "m", $36fd7633a39d2452$var$_AbstractChatCompletionRunner_validateParams).call(this, params);
    ...
    async _runFunctions(client, params, options) {
        ...
        const { maxChatCompletions: maxChatCompletions = $36fd7633a39d2452$var$DEFAULT_MAX_CHAT_COMPLETIONS } = options || {};
        ...
        for(let i = 0; i < maxChatCompletions; ++i){
            ...
            const content = $36fd7633a39d2452$var$__classPrivateFieldGet(this, $36fd7633a39d2452$var$_AbstractChatCompletionRunner_instances, "m", $36fd7633a39d2452$var$_AbstractChatCompletionRunner_stringifyFunctionCallResult).call(this, rawContent);
            this._addMessage({
                role: role,
                name: name,
                content: content
    ...
    async _runTools(client, params, options) {
        ...
        const inputTools = params.tools.map((tool)=>{
            if ((0, $5sdCJ.isAutoParsableTool)(tool)) {
                if (!tool.$callback) throw new $eK9Mf.OpenAIError("Tool given to `.runTools()` that does not have an associated function");
                return {
                    type: "function",
                    function: {
...
$36fd7633a39d2452$var$_AbstractChatCompletionRunner_instances = new WeakSet(), $36fd7633a39d2452$var$_AbstractChatCompletionRunner_getFinalContent = function _AbstractChatCompletionRunner_getFinalContent() {
    return $36fd7633a39d2452$var$__classPrivateFieldGet(this, $36fd7633a39d2452$var$_AbstractChatCompletionRunner_instances, "m", $36fd7633a39d2452$var$_AbstractChatCompletionRunner_getFinalMessage).call(this).content ?? null;
}, $36fd7633a39d2452$var$_AbstractChatCompletionRunner_getFinalMessage = function _AbstractChatCompletionRunner_getFinalMessage() {
    ...
    throw new $eK9Mf.OpenAIError("stream ended without producing a ChatCompletionMessage with role=assistant");
}, $36fd7633a39d2452$var$_AbstractChatCompletionRunner_getFinalFunctionCall = function _AbstractChatCompletionRunner_getFinalFunctionCall() {
    for(let i = this.messages.length - 1; i >= 0; i--){
        const message = this.messages[i];
        if ((0, $ehgTu.isAssistantMessage)(message) && message?.function_call) return message.function_call;
        if ((0, $ehgTu.isAssistantMessage)(message) && message?.tool_calls?.length) return message.tool_calls.at(-1)?.function;
    }
    return;
}, $36fd7633a39d2452$var$_AbstractChatCompletionRunner_getFinalFunctionCallResult = function _AbstractChatCompletionRunner_getFinalFunctionCallResult() {
    for(let i = this.messages.length - 1; i >= 0; i--){
        const message = this.messages[i];
        if ((0, $ehgTu.isFunctionMessage)(message) && message.content != null) return message.content;
        if ((0, $ehgTu.isToolMessage)(message) && message.content != null && typeof message.content === "string" && this.messages.some((x)=>x.role === "assistant" && x.tool_calls?.some((y)=>y.type === "function" && y.id === message.tool_call_id))) return message.content;
    }
    return;
}, $36fd7633a39d2452$var$_AbstractChatCompletionRunner_calculateTotalUsage = function _AbstractChatCompletionRunner_calculateTotalUsage() {
    const total = {
        completion_tokens: 0,
        prompt_tokens: 0,
        total_tokens: 0
    ...
    return total;
}, $36fd7633a39d2452$var$_AbstractChatCompletionRunner_validateParams = function _AbstractChatCompletionRunner_validateParams(params) {
    if (params.n != null && params.n > 1) throw new $eK9Mf.OpenAIError("ChatCompletion convenience helpers only support n=1 at this time. To use n>1, please use chat.completions.create() directly.");
}, $36fd7633a39d2452$var$_AbstractChatCompletionRunner_stringifyFunctionCallResult = function _AbstractChatCompletionRunner_stringifyFunctionCallResult(rawContent) {
...
"use strict";
var $57283e5fbe9cf52d$var$__classPrivateFieldSet = module.exports && module.exports.__classPrivateFieldSet || function(receiver, state, value, kind, f) {
    if (kind === "m") throw new TypeError("Private method is not writable");
    if (kind === "a" && !f) throw new TypeError("Private accessor was defined without a setter");
    if (typeof state === "function" ? receiver !== state || !f : !state.has(receiver)) throw new TypeError("Cannot write private member to an object whose class did not declare it");
    return kind === "a" ? f.call(receiver, value) : f ? f.value = value : state.set(receiver, value), value;
};
var $57283e5fbe9cf52d$var$__classPrivateFieldGet = module.exports && module.exports.__classPrivateFieldGet || function(receiver, state, kind, f) {
    if (kind === "a" && !f) throw new TypeError("Private accessor was defined without a getter");
    if (typeof state === "function" ? receiver !== state || !f : !state.has(receiver)) throw new TypeError("Cannot read private member from an object whose class did not declare it");
    return kind === "m" ? f : kind === "a" ? f.call(receiver) : f ? f.value : state.get(receiver);
};
var $57283e5fbe9cf52d$var$_EventStream_instances, $57283e5fbe9cf52d$var$_EventStream_connectedPromise, $57283e5fbe9cf52d$var$_EventStream_resolveConnectedPromise, $57283e5fbe9cf52d$var$_EventStream_rejectConnectedPromise, $57283e5fbe9cf52d$var$_EventStream_endPromise, $57283e5fbe9cf52d$var$_EventStream_resolveEndPromise, $57283e5fbe9cf52d$var$_EventStream_rejectEndPromise, $57283e5fbe9cf52d$var$_EventStream_listeners, $57283e5fbe9cf52d$var$_EventStream_ended, $57283e5fbe9cf52d$var$_EventStream_errored, $57283e5fbe9cf52d$var$_EventStream_aborted, $57283e5fbe9cf52d$var$_EventStream_catchingPromiseCreated, $57283e5fbe9cf52d$var$_EventStream_handleError;
Object.defineProperty(module.exports, "__esModule", {
    value: true
});
...
class $57283e5fbe9cf52d$var$EventStream {
    constructor(){
        ...
        $57283e5fbe9cf52d$var$__classPrivateFieldSet(this, $57283e5fbe9cf52d$var$_EventStream_connectedPromise, new Promise((resolve, reject)=>{
            $57283e5fbe9cf52d$var$__classPrivateFieldSet(this, $57283e5fbe9cf52d$var$_EventStream_resolveConnectedPromise, resolve, "f");
            $57283e5fbe9cf52d$var$__classPrivateFieldSet(this, $57283e5fbe9cf52d$var$_EventStream_rejectConnectedPromise, reject, "f");
        }), "f");
        $57283e5fbe9cf52d$var$__classPrivateFieldSet(this, $57283e5fbe9cf52d$var$_EventStream_endPromise, new Promise((resolve, reject)=>{
            $57283e5fbe9cf52d$var$__classPrivateFieldSet(this, $57283e5fbe9cf52d$var$_EventStream_resolveEndPromise, resolve, "f");
            $57283e5fbe9cf52d$var$__classPrivateFieldSet(this, $57283e5fbe9cf52d$var$_EventStream_rejectEndPromise, reject, "f");
        }), "f");
        // Don't let these promises cause unhandled rejection errors.
        // we will manually cause an unhandled rejection error later
        // if the user hasn't registered any error listener or called
        // any promise-returning method.
        $57283e5fbe9cf52d$var$__classPrivateFieldGet(this, $57283e5fbe9cf52d$var$_EventStream_connectedPromise, "f").catch(()=>{});
        $57283e5fbe9cf52d$var$__classPrivateFieldGet(this, $57283e5fbe9cf52d$var$_EventStream_endPromise, "f").catch(()=>{});
    }
    _run(executor) {
        ...
        setTimeout(()=>{
            executor().then(()=>{
                this._emitFinal();
                this._emit("end");
            }, $57283e5fbe9cf52d$var$__classPrivateFieldGet(this, $57283e5fbe9cf52d$var$_EventStream_instances, "m", $57283e5fbe9cf52d$var$_EventStream_handleError).bind(this));
        }, 0);
    }
    _connected() {
        if (this.ended) return;
        $57283e5fbe9cf52d$var$__classPrivateFieldGet(this, $57283e5fbe9cf52d$var$_EventStream_resolveConnectedPromise, "f").call(this);
        this._emit("connect");
    }
    get ended() {
        return $57283e5fbe9cf52d$var$__classPrivateFieldGet(this, $57283e5fbe9cf52d$var$_EventStream_ended, "f");
    }
    get errored() {
        return $57283e5fbe9cf52d$var$__classPrivateFieldGet(this, $57283e5fbe9cf52d$var$_EventStream_errored, "f");
    }
    get aborted() {
        return $57283e5fbe9cf52d$var$__classPrivateFieldGet(this, $57283e5fbe9cf52d$var$_EventStream_aborted, "f");
    }
    abort() {
     ...
     */ on(event, listener) {
        const listeners = $57283e5fbe9cf52d$var$__classPrivateFieldGet(this, $57283e5fbe9cf52d$var$_EventStream_listeners, "f")[event] || ($57283e5fbe9cf52d$var$__classPrivateFieldGet(this, $57283e5fbe9cf52d$var$_EventStream_listeners, "f")[event] = []);
        listeners.push({
            listener: listener
        });
        return this;
     ...
     * @returns this ChatCompletionStream, so that calls can be chained
     */ off(event, listener) {
        const listeners = $57283e5fbe9cf52d$var$__classPrivateFieldGet(this, $57283e5fbe9cf52d$var$_EventStream_listeners, "f")[event];
     ...
     */ emitted(event) {
        return new Promise((resolve, reject)=>{
            $57283e5fbe9cf52d$var$__classPrivateFieldSet(this, $57283e5fbe9cf52d$var$_EventStream_catchingPromiseCreated, true, "f");
    ...
    async done() {
        $57283e5fbe9cf52d$var$__classPrivateFieldSet(this, $57283e5fbe9cf52d$var$_EventStream_catchingPromiseCreated, true, "f");
        await $57283e5fbe9cf52d$var$__classPrivateFieldGet(this, $57283e5fbe9cf52d$var$_EventStream_endPromise, "f");
    }
    _emit(event, ...args) {
        // make sure we don't emit any events after end
        if ($57283e5fbe9cf52d$var$__classPrivateFieldGet(this, $57283e5fbe9cf52d$var$_EventStream_ended, "f")) return;
        if (event === "end") {
            $57283e5fbe9cf52d$var$__classPrivateFieldSet(this, $57283e5fbe9cf52d$var$_EventStream_ended, true, "f");
            $57283e5fbe9cf52d$var$__classPrivateFieldGet(this, $57283e5fbe9cf52d$var$_EventStream_resolveEndPromise, "f").call(this);
        }
        const listeners = $57283e5fbe9cf52d$var$__classPrivateFieldGet(this, $57283e5fbe9cf52d$var$_EventStream_listeners, "f")[event];
        if (listeners) {
            $57283e5fbe9cf52d$var$__classPrivateFieldGet(this, $57283e5fbe9cf52d$var$_EventStream_listeners, "f")[event] = listeners.filter((l)=>!l.once);
            listeners.forEach(({ listener: listener })=>listener(...args));
        }
        if (event === "abort") {
            const error = args[0];
            if (!$57283e5fbe9cf52d$var$__classPrivateFieldGet(this, $57283e5fbe9cf52d$var$_EventStream_catchingPromiseCreated, "f") && !listeners?.length) Promise.reject(error);
            $57283e5fbe9cf52d$var$__classPrivateFieldGet(this, $57283e5fbe9cf52d$var$_EventStream_rejectConnectedPromise, "f").call(this, error);
            $57283e5fbe9cf52d$var$__classPrivateFieldGet(this, $57283e5fbe9cf52d$var$_EventStream_rejectEndPromise, "f").call(this, error);
            this._emit("end");
            return;
        }
        if (event === "error") {
            ...
            const error = args[0];
            if (!$57283e5fbe9cf52d$var$__classPrivateFieldGet(this, $57283e5fbe9cf52d$var$_EventStream_catchingPromiseCreated, "f") && !listeners?.length) // Trigger an unhandled rejection if the user hasn't registered any error handlers.
...
$57283e5fbe9cf52d$var$_EventStream_connectedPromise = new WeakMap(), $57283e5fbe9cf52d$var$_EventStream_resolveConnectedPromise = new WeakMap(), $57283e5fbe9cf52d$var$_EventStream_rejectConnectedPromise = new WeakMap(), $57283e5fbe9cf52d$var$_EventStream_endPromise = new WeakMap(), $57283e5fbe9cf52d$var$_EventStream_resolveEndPromise = new WeakMap(), $57283e5fbe9cf52d$var$_EventStream_rejectEndPromise = new WeakMap(), $57283e5fbe9cf52d$var$_EventStream_listeners = new WeakMap(), $57283e5fbe9cf52d$var$_EventStream_ended = new WeakMap(), $57283e5fbe9cf52d$var$_EventStream_errored = new WeakMap(), $57283e5fbe9cf52d$var$_EventStream_aborted = new WeakMap(), $57283e5fbe9cf52d$var$_EventStream_catchingPromiseCreated = new WeakMap(), $57283e5fbe9cf52d$var$_EventStream_instances = new WeakSet(), $57283e5fbe9cf52d$var$_EventStream_handleError = function _EventStream_handleError(error) {
    $57283e5fbe9cf52d$var$__classPrivateFieldSet(this, $57283e5fbe9cf52d$var$_EventStream_errored, true, "f");
    if (error instanceof Error && error.name === "AbortError") error = new $eK9Mf.APIUserAbortError();
    if (error instanceof $eK9Mf.APIUserAbortError) {
        $57283e5fbe9cf52d$var$__classPrivateFieldSet(this, $57283e5fbe9cf52d$var$_EventStream_aborted, true, "f");
...
function $3f8a22a9a07b787b$var$maybeParseChatCompletion(completion, params) {
    if (!params || !$3f8a22a9a07b787b$var$hasAutoParseableInput(params)) return {
        ...completion,
...
function $3f8a22a9a07b787b$var$parseChatCompletion(completion, params) {
    const choices = completion.choices.map((choice)=>{
        ...
        if (choice.finish_reason === "content_filter") throw new $eK9Mf.ContentFilterFinishReasonError();
        return {
            ...choice,
            message: {
                ...choice.message,
                tool_calls: choice.message.tool_calls?.map((toolCall)=>$3f8a22a9a07b787b$var$parseToolCall(params, toolCall)) ?? [],
                parsed: choice.message.content && !choice.message.refusal ? $3f8a22a9a07b787b$var$parseResponseFormat(params, choice.message.content) : null
            }
        };
    });
    return {
...
function $3f8a22a9a07b787b$var$parseToolCall(params, toolCall) {
    ...
    return {
        ...
        function: {
            ...toolCall.function,
            parsed_arguments: $3f8a22a9a07b787b$var$isAutoParsableTool(inputTool) ? inputTool.$parseRaw(toolCall.function.arguments) : inputTool?.function.strict ? JSON.parse(toolCall.function.arguments) : null
        }
    };
}
function $3f8a22a9a07b787b$var$shouldParseToolCall(params, toolCall) {
    ...
    const inputTool = params.tools?.find((inputTool)=>inputTool.function?.name === toolCall.function.name);
    return $3f8a22a9a07b787b$var$isAutoParsableTool(inputTool) || inputTool?.function.strict || false;
}
...
function $3f8a22a9a07b787b$var$hasAutoParseableInput(params) {
    ...
    return params.tools?.some((t)=>$3f8a22a9a07b787b$var$isAutoParsableTool(t) || t.type === "function" && t.function.strict === true) ?? false;
}
...
function $3f8a22a9a07b787b$var$validateInputTools(tools) {
    for (const tool of tools ?? []){
        if (tool.type !== "function") throw new $eK9Mf.OpenAIError(`Currently only \`function\` tool types support auto-parsing; Received \`${tool.type}\``);
        if (tool.function.strict !== true) throw new $eK9Mf.OpenAIError(`The \`${tool.function.name}\` tool is not marked with \`strict: true\`. Only strict function tools can be auto-parsed`);
    }
}
...
class $781c7087a4b7844b$var$ChatCompletionStreamingRunner extends $elo0k.ChatCompletionStream {
    ...
    static runTools(client, params, options) {
        const runner = new $781c7087a4b7844b$var$ChatCompletionStreamingRunner(// @ts-expect-error TODO these types are incompatible
        params);
        const opts = {
            ...options,
            headers: {
...
module.exports.ChatCompletionStreamingRunner = $781c7087a4b7844b$var$ChatCompletionStreamingRunner;

});
parcelRegister("elo0k", function(module, exports) {
"use strict";
var $a715a59d020828a5$var$__classPrivateFieldSet = module.exports && module.exports.__classPrivateFieldSet || function(receiver, state, value, kind, f) {
    if (kind === "m") throw new TypeError("Private method is not writable");
    if (kind === "a" && !f) throw new TypeError("Private accessor was defined without a setter");
    if (typeof state === "function" ? receiver !== state || !f : !state.has(receiver)) throw new TypeError("Cannot write private member to an object whose class did not declare it");
    return kind === "a" ? f.call(receiver, value) : f ? f.value = value : state.set(receiver, value), value;
};
var $a715a59d020828a5$var$__classPrivateFieldGet = module.exports && module.exports.__classPrivateFieldGet || function(receiver, state, kind, f) {
    if (kind === "a" && !f) throw new TypeError("Private accessor was defined without a getter");
    if (typeof state === "function" ? receiver !== state || !f : !state.has(receiver)) throw new TypeError("Cannot read private member from an object whose class did not declare it");
    return kind === "m" ? f : kind === "a" ? f.call(receiver) : f ? f.value : state.get(receiver);
};
var $a715a59d020828a5$var$_ChatCompletionStream_instances, $a715a59d020828a5$var$_ChatCompletionStream_params, $a715a59d020828a5$var$_ChatCompletionStream_choiceEventStates, $a715a59d020828a5$var$_ChatCompletionStream_currentChatCompletionSnapshot, $a715a59d020828a5$var$_ChatCompletionStream_beginRequest, $a715a59d020828a5$var$_ChatCompletionStream_getChoiceEventState, $a715a59d020828a5$var$_ChatCompletionStream_addChunk, $a715a59d020828a5$var$_ChatCompletionStream_emitToolCallDoneEvent, $a715a59d020828a5$var$_ChatCompletionStream_emitContentDoneEvents, $a715a59d020828a5$var$_ChatCompletionStream_endRequest, $a715a59d020828a5$var$_ChatCompletionStream_getAutoParseableResponseFormat, $a715a59d020828a5$var$_ChatCompletionStream_accumulateChatCompletion;
Object.defineProperty(module.exports, "__esModule", {
    value: true
});
...
class $a715a59d020828a5$var$ChatCompletionStream extends $4II4O.AbstractChatCompletionRunner {
    constructor(params){
        ...
        $a715a59d020828a5$var$__classPrivateFieldSet(this, $a715a59d020828a5$var$_ChatCompletionStream_params, params, "f");
        $a715a59d020828a5$var$__classPrivateFieldSet(this, $a715a59d020828a5$var$_ChatCompletionStream_choiceEventStates, [], "f");
    }
    get currentChatCompletionSnapshot() {
        return $a715a59d020828a5$var$__classPrivateFieldGet(this, $a715a59d020828a5$var$_ChatCompletionStream_currentChatCompletionSnapshot, "f");
    }
    /**
    ...
    async _createChatCompletion(client, params, options) {
        ...
        $a715a59d020828a5$var$__classPrivateFieldGet(this, $a715a59d020828a5$var$_ChatCompletionStream_instances, "m", $a715a59d020828a5$var$_ChatCompletionStream_beginRequest).call(this);
        ...
        this._connected();
        for await (const chunk of stream)$a715a59d020828a5$var$__classPrivateFieldGet(this, $a715a59d020828a5$var$_ChatCompletionStream_instances, "m", $a715a59d020828a5$var$_ChatCompletionStream_addChunk).call(this, chunk);
        if (stream.controller.signal?.aborted) throw new $eK9Mf.APIUserAbortError();
        return this._addChatCompletion($a715a59d020828a5$var$__classPrivateFieldGet(this, $a715a59d020828a5$var$_ChatCompletionStream_instances, "m", $a715a59d020828a5$var$_ChatCompletionStream_endRequest).call(this));
    }
    async _fromReadableStream(readableStream, options) {
        ...
        for await (const chunk of stream){
            ...
            this._addChatCompletion($a715a59d020828a5$var$__classPrivateFieldGet(this, $a715a59d020828a5$var$_ChatCompletionStream_instances, "m", $a715a59d020828a5$var$_ChatCompletionStream_endRequest).call(this));
            $a715a59d020828a5$var$__classPrivateFieldGet(this, $a715a59d020828a5$var$_ChatCompletionStream_instances, "m", $a715a59d020828a5$var$_ChatCompletionStream_addChunk).call(this, chunk);
            chatId = chunk.id;
        }
        if (stream.controller.signal?.aborted) throw new $eK9Mf.APIUserAbortError();
        return this._addChatCompletion($a715a59d020828a5$var$__classPrivateFieldGet(this, $a715a59d020828a5$var$_ChatCompletionStream_instances, "m", $a715a59d020828a5$var$_ChatCompletionStream_endRequest).call(this));
    }
    [($a715a59d020828a5$var$_ChatCompletionStream_params = new WeakMap(), $a715a59d020828a5$var$_ChatCompletionStream_choiceEventStates = new WeakMap(), $a715a59d020828a5$var$_ChatCompletionStream_currentChatCompletionSnapshot = new WeakMap(), $a715a59d020828a5$var$_ChatCompletionStream_instances = new WeakSet(), $a715a59d020828a5$var$_ChatCompletionStream_beginRequest = function _ChatCompletionStream_beginRequest() {
        if (this.ended) return;
        $a715a59d020828a5$var$__classPrivateFieldSet(this, $a715a59d020828a5$var$_ChatCompletionStream_currentChatCompletionSnapshot, undefined, "f");
    }, $a715a59d020828a5$var$_ChatCompletionStream_getChoiceEventState = function _ChatCompletionStream_getChoiceEventState(choice) {
        let state = $a715a59d020828a5$var$__classPrivateFieldGet(this, $a715a59d020828a5$var$_ChatCompletionStream_choiceEventStates, "f")[choice.index];
        ...
        $a715a59d020828a5$var$__classPrivateFieldGet(this, $a715a59d020828a5$var$_ChatCompletionStream_choiceEventStates, "f")[choice.index] = state;
        return state;
    }, $a715a59d020828a5$var$_ChatCompletionStream_addChunk = function _ChatCompletionStream_addChunk(chunk) {
        if (this.ended) return;
        const completion = $a715a59d020828a5$var$__classPrivateFieldGet(this, $a715a59d020828a5$var$_ChatCompletionStream_instances, "m", $a715a59d020828a5$var$_ChatCompletionStream_accumulateChatCompletion).call(this, chunk);
        ...
        for (const choice of chunk.choices){
            ...
            const state = $a715a59d020828a5$var$__classPrivateFieldGet(this, $a715a59d020828a5$var$_ChatCompletionStream_instances, "m", $a715a59d020828a5$var$_ChatCompletionStream_getChoiceEventState).call(this, choiceSnapshot);
            if (choiceSnapshot.finish_reason) {
                $a715a59d020828a5$var$__classPrivateFieldGet(this, $a715a59d020828a5$var$_ChatCompletionStream_instances, "m", $a715a59d020828a5$var$_ChatCompletionStream_emitContentDoneEvents).call(this, choiceSnapshot);
                if (state.current_tool_call_index != null) $a715a59d020828a5$var$__classPrivateFieldGet(this, $a715a59d020828a5$var$_ChatCompletionStream_instances, "m", $a715a59d020828a5$var$_ChatCompletionStream_emitToolCallDoneEvent).call(this, choiceSnapshot, state.current_tool_call_index);
            }
    ...
    }, $a715a59d020828a5$var$_ChatCompletionStream_emitToolCallDoneEvent = function _ChatCompletionStream_emitToolCallDoneEvent(choiceSnapshot, toolCallIndex) {
        const state = $a715a59d020828a5$var$__classPrivateFieldGet(this, $a715a59d020828a5$var$_ChatCompletionStream_instances, "m", $a715a59d020828a5$var$_ChatCompletionStream_getChoiceEventState).call(this, choiceSnapshot);
        ...
        if (toolCallSnapshot.type === "function") {
            const inputTool = $a715a59d020828a5$var$__classPrivateFieldGet(this, $a715a59d020828a5$var$_ChatCompletionStream_params, "f")?.tools?.find((tool)=>tool.type === "function" && tool.function.name === toolCallSnapshot.function.name);
            this._emit("tool_calls.function.arguments.done", {
                name: toolCallSnapshot.function.name,
                index: toolCallIndex,
                arguments: toolCallSnapshot.function.arguments,
                parsed_arguments: (0, $5sdCJ.isAutoParsableTool)(inputTool) ? inputTool.$parseRaw(toolCallSnapshot.function.arguments) : inputTool?.function.strict ? JSON.parse(toolCallSnapshot.function.arguments) : null
            });
        } else $a715a59d020828a5$var$assertNever(toolCallSnapshot.type);
    }, $a715a59d020828a5$var$_ChatCompletionStream_emitContentDoneEvents = function _ChatCompletionStream_emitContentDoneEvents(choiceSnapshot) {
        const state = $a715a59d020828a5$var$__classPrivateFieldGet(this, $a715a59d020828a5$var$_ChatCompletionStream_instances, "m", $a715a59d020828a5$var$_ChatCompletionStream_getChoiceEventState).call(this, choiceSnapshot);
        if (choiceSnapshot.message.content && !state.content_done) {
            state.content_done = true;
            const responseFormat = $a715a59d020828a5$var$__classPrivateFieldGet(this, $a715a59d020828a5$var$_ChatCompletionStream_instances, "m", $a715a59d020828a5$var$_ChatCompletionStream_getAutoParseableResponseFormat).call(this);
    ...
    }, $a715a59d020828a5$var$_ChatCompletionStream_endRequest = function _ChatCompletionStream_endRequest() {
        if (this.ended) throw new $eK9Mf.OpenAIError(`stream has ended, this shouldn't happen`);
        const snapshot = $a715a59d020828a5$var$__classPrivateFieldGet(this, $a715a59d020828a5$var$_ChatCompletionStream_currentChatCompletionSnapshot, "f");
        if (!snapshot) throw new $eK9Mf.OpenAIError(`request ended without sending any chunks`);
        $a715a59d020828a5$var$__classPrivateFieldSet(this, $a715a59d020828a5$var$_ChatCompletionStream_currentChatCompletionSnapshot, undefined, "f");
        $a715a59d020828a5$var$__classPrivateFieldSet(this, $a715a59d020828a5$var$_ChatCompletionStream_choiceEventStates, [], "f");
        return $a715a59d020828a5$var$finalizeChatCompletion(snapshot, $a715a59d020828a5$var$__classPrivateFieldGet(this, $a715a59d020828a5$var$_ChatCompletionStream_params, "f"));
    }, $a715a59d020828a5$var$_ChatCompletionStream_getAutoParseableResponseFormat = function _ChatCompletionStream_getAutoParseableResponseFormat() {
        const responseFormat = $a715a59d020828a5$var$__classPrivateFieldGet(this, $a715a59d020828a5$var$_ChatCompletionStream_params, "f")?.response_format;
        if ((0, $5sdCJ.isAutoParsableResponseFormat)(responseFormat)) return responseFormat;
        return null;
    }, $a715a59d020828a5$var$_ChatCompletionStream_accumulateChatCompletion = function _ChatCompletionStream_accumulateChatCompletion(chunk) {
        var _a, _b, _c, _d;
        let snapshot = $a715a59d020828a5$var$__classPrivateFieldGet(this, $a715a59d020828a5$var$_ChatCompletionStream_currentChatCompletionSnapshot, "f");
        const { choices: choices, ...rest } = chunk;
        if (!snapshot) snapshot = $a715a59d020828a5$var$__classPrivateFieldSet(this, $a715a59d020828a5$var$_ChatCompletionStream_currentChatCompletionSnapshot, {
            ...rest,
            choices: []
        }, "f");
        ...
        for (const { delta: delta, finish_reason: finish_reason, index: index, logprobs: logprobs = null, ...other } of chunk.choices){
            ...
            if (finish_reason) {
                ...
                if ($a715a59d020828a5$var$__classPrivateFieldGet(this, $a715a59d020828a5$var$_ChatCompletionStream_params, "f") && (0, $5sdCJ.hasAutoParseableInput)($a715a59d020828a5$var$__classPrivateFieldGet(this, $a715a59d020828a5$var$_ChatCompletionStream_params, "f"))) {
                    if (finish_reason === "length") throw new $eK9Mf.LengthFinishReasonError();
                    if (finish_reason === "content_filter") throw new $eK9Mf.ContentFilterFinishReasonError();
                }
            }
            ...
            if (content) {
                ...
                if (!choice.message.refusal && $a715a59d020828a5$var$__classPrivateFieldGet(this, $a715a59d020828a5$var$_ChatCompletionStream_instances, "m", $a715a59d020828a5$var$_ChatCompletionStream_getAutoParseableResponseFormat).call(this)) choice.message.parsed = (0, $dcUDn.partialParse)(choice.message.content);
            }
            if (tool_calls) {
                ...
                for (const { index: index, id: id, type: type, function: fn, ...rest } of tool_calls){
                    ...
                    if (fn?.arguments) {
                        ...
                        if ((0, $5sdCJ.shouldParseToolCall)($a715a59d020828a5$var$__classPrivateFieldGet(this, $a715a59d020828a5$var$_ChatCompletionStream_params, "f"), tool_call)) tool_call.function.parsed_arguments = (0, $dcUDn.partialParse)(tool_call.function.arguments);
                    }
                }
            }
        }
...
function $a715a59d020828a5$var$finalizeChatCompletion(snapshot, params) {
    ...
    const completion = {
        ...
        choices: choices.map(({ message: message, finish_reason: finish_reason, index: index, logprobs: logprobs, ...choiceRest })=>{
            if (!finish_reason) throw new $eK9Mf.OpenAIError(`missing finish_reason for choice ${index}`);
            ...
            if (function_call) {
                ...
                if (args == null) throw new $eK9Mf.OpenAIError(`missing function_call.arguments for choice ${index}`);
                if (!name) throw new $eK9Mf.OpenAIError(`missing function_call.name for choice ${index}`);
                return {
                    ...choiceRest,
                    message: {
                        content: content,
            ...
            if (tool_calls) return {
                ...
                message: {
                    ...
                    tool_calls: tool_calls.map((tool_call, i)=>{
                        ...
                        if (id == null) throw new $eK9Mf.OpenAIError(`missing choices[${index}].tool_calls[${i}].id\n${$a715a59d020828a5$var$str(snapshot)}`);
                        if (type == null) throw new $eK9Mf.OpenAIError(`missing choices[${index}].tool_calls[${i}].type\n${$a715a59d020828a5$var$str(snapshot)}`);
                        if (name == null) throw new $eK9Mf.OpenAIError(`missing choices[${index}].tool_calls[${i}].function.name\n${$a715a59d020828a5$var$str(snapshot)}`);
                        if (args == null) throw new $eK9Mf.OpenAIError(`missing choices[${index}].tool_calls[${i}].function.arguments\n${$a715a59d020828a5$var$str(snapshot)}`);
                        return {
                            ...toolRest,
                            id: id,
                            type: type,
...
const $99d853b34be6f92f$var$INF = $99d853b34be6f92f$var$INFINITY | $99d853b34be6f92f$var$MINUS_INFINITY;
const $99d853b34be6f92f$var$SPECIAL = $99d853b34be6f92f$var$NULL | $99d853b34be6f92f$var$BOOL | $99d853b34be6f92f$var$INF | $99d853b34be6f92f$var$NAN;
const $99d853b34be6f92f$var$ATOM = $99d853b34be6f92f$var$STR | $99d853b34be6f92f$var$NUM | $99d853b34be6f92f$var$SPECIAL;
 ...
 */ function $99d853b34be6f92f$var$parseJSON(jsonString, allowPartial = $99d853b34be6f92f$var$Allow.ALL) {
...
const $99d853b34be6f92f$var$_parseJSON = (jsonString, allow)=>{
    ...
    const parseAny = ()=>{
        ...
        if (jsonString.substring(index, index + 4) === "null" || $99d853b34be6f92f$var$Allow.NULL & allow && length - index < 4 && "null".startsWith(jsonString.substring(index))) {
            index += 4;
            return null;
        }
        if (jsonString.substring(index, index + 4) === "true" || $99d853b34be6f92f$var$Allow.BOOL & allow && length - index < 4 && "true".startsWith(jsonString.substring(index))) {
            index += 4;
            return true;
        }
        if (jsonString.substring(index, index + 5) === "false" || $99d853b34be6f92f$var$Allow.BOOL & allow && length - index < 5 && "false".startsWith(jsonString.substring(index))) {
            index += 5;
            return false;
        }
        if (jsonString.substring(index, index + 8) === "Infinity" || $99d853b34be6f92f$var$Allow.INFINITY & allow && length - index < 8 && "Infinity".startsWith(jsonString.substring(index))) {
            index += 8;
            return Infinity;
        }
        if (jsonString.substring(index, index + 9) === "-Infinity" || $99d853b34be6f92f$var$Allow.MINUS_INFINITY & allow && 1 < length - index && length - index < 9 && "-Infinity".startsWith(jsonString.substring(index))) {
            index += 9;
            return -Infinity;
        }
        if (jsonString.substring(index, index + 3) === "NaN" || $99d853b34be6f92f$var$Allow.NAN & allow && length - index < 3 && "NaN".startsWith(jsonString.substring(index))) {
            index += 3;
            return NaN;
        }
        return parseNum();
    ...
    const parseStr = ()=>{
        ...
        else if ($99d853b34be6f92f$var$Allow.STR & allow) try {
            return JSON.parse(jsonString.substring(start, index - Number(escape)) + '"');
        } catch (e) {
    ...
    const parseNum = ()=>{
        if (index === 0) {
            if (jsonString === "-" && $99d853b34be6f92f$var$Allow.NUM & allow) markPartialJSON("Not sure what '-' is");
            try {
                return JSON.parse(jsonString);
            } catch (e) {
                if ($99d853b34be6f92f$var$Allow.NUM & allow) try {
        ...
        if (index == length && !($99d853b34be6f92f$var$Allow.NUM & allow)) markPartialJSON("Unterminated number literal");
        try {
            return JSON.parse(jsonString.substring(start, index));
        } catch (e) {
            if (jsonString.substring(start, index) === "-" && $99d853b34be6f92f$var$Allow.NUM & allow) markPartialJSON("Not sure what '-' is");
            try {
...
const $99d853b34be6f92f$var$partialParse = (input)=>$99d853b34be6f92f$var$parseJSON(input, $99d853b34be6f92f$var$Allow.ALL ^ $99d853b34be6f92f$var$Allow.NUM);
...
"use strict";
// File generated from our OpenAPI spec by Stainless. See CONTRIBUTING.md for details.
var $39341f09452b3385$var$__createBinding = module.exports && module.exports.__createBinding || (Object.create ? function(o, m, k, k2) {
    if (k2 === undefined) k2 = k;
    var desc = Object.getOwnPropertyDescriptor(m, k);
    if (!desc || ("get" in desc ? !m.__esModule : desc.writable || desc.configurable)) desc = {
        enumerable: true,
...
var $39341f09452b3385$var$__setModuleDefault = module.exports && module.exports.__setModuleDefault || (Object.create ? function(o, v) {
    Object.defineProperty(o, "default", {
        enumerable: true,
        value: v
    });
...
var $39341f09452b3385$var$__importStar = module.exports && module.exports.__importStar || function(mod) {
    if (mod && mod.__esModule) return mod;
    var result = {};
    if (mod != null) {
        for(var k in mod)if (k !== "default" && Object.prototype.hasOwnProperty.call(mod, k)) $39341f09452b3385$var$__createBinding(result, mod, k);
    }
...
const $39341f09452b3385$var$MessagesAPI = $39341f09452b3385$var$__importStar((parcelRequire("2CRVw")));
...
class $39341f09452b3385$var$Threads extends $dQuSh.APIResource {
     ...
     */ createAndRunStream(body, options) {
        return $bERsK.AssistantStream.createThreadAssistantStream(body, this._client.beta.threads, options);
    }
}
...
"use strict";
var $87cce6b238037c0d$var$__createBinding = module.exports && module.exports.__createBinding || (Object.create ? function(o, m, k, k2) {
    if (k2 === undefined) k2 = k;
    var desc = Object.getOwnPropertyDescriptor(m, k);
    if (!desc || ("get" in desc ? !m.__esModule : desc.writable || desc.configurable)) desc = {
        enumerable: true,
...
var $87cce6b238037c0d$var$__setModuleDefault = module.exports && module.exports.__setModuleDefault || (Object.create ? function(o, v) {
    Object.defineProperty(o, "default", {
        enumerable: true,
        value: v
    });
...
var $87cce6b238037c0d$var$__importStar = module.exports && module.exports.__importStar || function(mod) {
    if (mod && mod.__esModule) return mod;
    var result = {};
    if (mod != null) {
        for(var k in mod)if (k !== "default" && Object.prototype.hasOwnProperty.call(mod, k)) $87cce6b238037c0d$var$__createBinding(result, mod, k);
    }
    $87cce6b238037c0d$var$__setModuleDefault(result, mod);
    return result;
};
var $87cce6b238037c0d$var$__classPrivateFieldGet = module.exports && module.exports.__classPrivateFieldGet || function(receiver, state, kind, f) {
    if (kind === "a" && !f) throw new TypeError("Private accessor was defined without a getter");
    if (typeof state === "function" ? receiver !== state || !f : !state.has(receiver)) throw new TypeError("Cannot read private member from an object whose class did not declare it");
    return kind === "m" ? f : kind === "a" ? f.call(receiver) : f ? f.value : state.get(receiver);
};
var $87cce6b238037c0d$var$__classPrivateFieldSet = module.exports && module.exports.__classPrivateFieldSet || function(receiver, state, value, kind, f) {
    if (kind === "m") throw new TypeError("Private method is not writable");
    if (kind === "a" && !f) throw new TypeError("Private accessor was defined without a setter");
    if (typeof state === "function" ? receiver !== state || !f : !state.has(receiver)) throw new TypeError("Cannot write private member to an object whose class did not declare it");
    return kind === "a" ? f.call(receiver, value) : f ? f.value = value : state.set(receiver, value), value;
};
var $87cce6b238037c0d$var$_AssistantStream_instances, $87cce6b238037c0d$var$_AssistantStream_events, $87cce6b238037c0d$var$_AssistantStream_runStepSnapshots, $87cce6b238037c0d$var$_AssistantStream_messageSnapshots, $87cce6b238037c0d$var$_AssistantStream_messageSnapshot, $87cce6b238037c0d$var$_AssistantStream_finalRun, $87cce6b238037c0d$var$_AssistantStream_currentContentIndex, $87cce6b238037c0d$var$_AssistantStream_currentContent, $87cce6b238037c0d$var$_AssistantStream_currentToolCallIndex, $87cce6b238037c0d$var$_AssistantStream_currentToolCall, $87cce6b238037c0d$var$_AssistantStream_currentEvent, $87cce6b238037c0d$var$_AssistantStream_currentRunSnapshot, $87cce6b238037c0d$var$_AssistantStream_currentRunStepSnapshot, $87cce6b238037c0d$var$_AssistantStream_addEvent, $87cce6b238037c0d$var$_AssistantStream_endRequest, $87cce6b238037c0d$var$_AssistantStream_handleMessage, $87cce6b238037c0d$var$_AssistantStream_handleRunStep, $87cce6b238037c0d$var$_AssistantStream_handleEvent, $87cce6b238037c0d$var$_AssistantStream_accumulateRunStep, $87cce6b238037c0d$var$_AssistantStream_accumulateMessage, $87cce6b238037c0d$var$_AssistantStream_accumulateContent, $87cce6b238037c0d$var$_AssistantStream_handleRun;
Object.defineProperty(module.exports, "__esModule", {
    value: true
});
...
class $87cce6b238037c0d$var$AssistantStream extends $7tW0Y.EventStream {
    ...
    [($87cce6b238037c0d$var$_AssistantStream_events = new WeakMap(), $87cce6b238037c0d$var$_AssistantStream_runStepSnapshots = new WeakMap(), $87cce6b238037c0d$var$_AssistantStream_messageSnapshots = new WeakMap(), $87cce6b238037c0d$var$_AssistantStream_messageSnapshot = new WeakMap(), $87cce6b238037c0d$var$_AssistantStream_finalRun = new WeakMap(), $87cce6b238037c0d$var$_AssistantStream_currentContentIndex = new WeakMap(), $87cce6b238037c0d$var$_AssistantStream_currentContent = new WeakMap(), $87cce6b238037c0d$var$_AssistantStream_currentToolCallIndex = new WeakMap(), $87cce6b238037c0d$var$_AssistantStream_currentToolCall = new WeakMap(), $87cce6b238037c0d$var$_AssistantStream_currentEvent = new WeakMap(), $87cce6b238037c0d$var$_AssistantStream_currentRunSnapshot = new WeakMap(), $87cce6b238037c0d$var$_AssistantStream_currentRunStepSnapshot = new WeakMap(), $87cce6b238037c0d$var$_AssistantStream_instances = new WeakSet(), Symbol.asyncIterator)]() {
        const pushQueue = [];
        const readQueue = [];
        let done = false;
    ...
    async _fromReadableStream(readableStream, options) {
        ...
        this._connected();
        const stream = $9zADT.Stream.fromReadableStream(readableStream, this.controller);
        for await (const event of stream)$87cce6b238037c0d$var$__classPrivateFieldGet(this, $87cce6b238037c0d$var$_AssistantStream_instances, "m", $87cce6b238037c0d$var$_AssistantStream_addEvent).call(this, event);
        if (stream.controller.signal?.aborted) throw new $eK9Mf.APIUserAbortError();
        return this._addRun($87cce6b238037c0d$var$__classPrivateFieldGet(this, $87cce6b238037c0d$var$_AssistantStream_instances, "m", $87cce6b238037c0d$var$_AssistantStream_endRequest).call(this));
    }
    toReadableStream() {
        const stream = new $9zADT.Stream(this[Symbol.asyncIterator].bind(this), this.controller);
        return stream.toReadableStream();
    ...
    currentEvent() {
        return $87cce6b238037c0d$var$__classPrivateFieldGet(this, $87cce6b238037c0d$var$_AssistantStream_currentEvent, "f");
    }
    currentRun() {
        return $87cce6b238037c0d$var$__classPrivateFieldGet(this, $87cce6b238037c0d$var$_AssistantStream_currentRunSnapshot, "f");
    }
    currentMessageSnapshot() {
        return $87cce6b238037c0d$var$__classPrivateFieldGet(this, $87cce6b238037c0d$var$_AssistantStream_messageSnapshot, "f");
    }
    currentRunStepSnapshot() {
        return $87cce6b238037c0d$var$__classPrivateFieldGet(this, $87cce6b238037c0d$var$_AssistantStream_currentRunStepSnapshot, "f");
    }
    async finalRunSteps() {
        await this.done();
        return Object.values($87cce6b238037c0d$var$__classPrivateFieldGet(this, $87cce6b238037c0d$var$_AssistantStream_runStepSnapshots, "f"));
    }
    async finalMessages() {
        await this.done();
        return Object.values($87cce6b238037c0d$var$__classPrivateFieldGet(this, $87cce6b238037c0d$var$_AssistantStream_messageSnapshots, "f"));
    }
    async finalRun() {
        await this.done();
        if (!$87cce6b238037c0d$var$__classPrivateFieldGet(this, $87cce6b238037c0d$var$_AssistantStream_finalRun, "f")) throw Error("Final run was not received.");
        return $87cce6b238037c0d$var$__classPrivateFieldGet(this, $87cce6b238037c0d$var$_AssistantStream_finalRun, "f");
    }
    ...
    static accumulateDelta(acc, delta) {
        for (const [key, deltaValue] of Object.entries(delta)){
            ...
            if (typeof accValue === "string" && typeof deltaValue === "string") accValue += deltaValue;
            ...
            else if ($87cce6b238037c0d$var$Core.isObj(accValue) && $87cce6b238037c0d$var$Core.isObj(deltaValue)) accValue = this.accumulateDelta(accValue, deltaValue);
                ...
                for (const deltaEntry of deltaValue){
                    if (!$87cce6b238037c0d$var$Core.isObj(deltaEntry)) throw new Error(`Expected array delta entry to be an object but got: ${deltaEntry}`);
...
$87cce6b238037c0d$var$_AssistantStream_addEvent = function _AssistantStream_addEvent(event) {
    if (this.ended) return;
    $87cce6b238037c0d$var$__classPrivateFieldSet(this, $87cce6b238037c0d$var$_AssistantStream_currentEvent, event, "f");
    $87cce6b238037c0d$var$__classPrivateFieldGet(this, $87cce6b238037c0d$var$_AssistantStream_instances, "m", $87cce6b238037c0d$var$_AssistantStream_handleEvent).call(this, event);
    switch(event.event){
        case "thread.created":
            break;
        ...
        case "thread.run.expired":
            $87cce6b238037c0d$var$__classPrivateFieldGet(this, $87cce6b238037c0d$var$_AssistantStream_instances, "m", $87cce6b238037c0d$var$_AssistantStream_handleRun).call(this, event);
            break;
        ...
        case "thread.run.step.expired":
            $87cce6b238037c0d$var$__classPrivateFieldGet(this, $87cce6b238037c0d$var$_AssistantStream_instances, "m", $87cce6b238037c0d$var$_AssistantStream_handleRunStep).call(this, event);
            break;
        ...
        case "thread.message.incomplete":
            $87cce6b238037c0d$var$__classPrivateFieldGet(this, $87cce6b238037c0d$var$_AssistantStream_instances, "m", $87cce6b238037c0d$var$_AssistantStream_handleMessage).call(this, event);
            break;
        case "error":
    ...
    if (this.ended) throw new $eK9Mf.OpenAIError(`stream has ended, this shouldn't happen`);
    if (!$87cce6b238037c0d$var$__classPrivateFieldGet(this, $87cce6b238037c0d$var$_AssistantStream_finalRun, "f")) throw Error("Final run has not been received");
    return $87cce6b238037c0d$var$__classPrivateFieldGet(this, $87cce6b238037c0d$var$_AssistantStream_finalRun, "f");
}, $87cce6b238037c0d$var$_AssistantStream_handleMessage = function _AssistantStream_handleMessage(event) {
    const [accumulatedMessage, newContent] = $87cce6b238037c0d$var$__classPrivateFieldGet(this, $87cce6b238037c0d$var$_AssistantStream_instances, "m", $87cce6b238037c0d$var$_AssistantStream_accumulateMessage).call(this, event, $87cce6b238037c0d$var$__classPrivateFieldGet(this, $87cce6b238037c0d$var$_AssistantStream_messageSnapshot, "f"));
    $87cce6b238037c0d$var$__classPrivateFieldSet(this, $87cce6b238037c0d$var$_AssistantStream_messageSnapshot, accumulatedMessage, "f");
    $87cce6b238037c0d$var$__classPrivateFieldGet(this, $87cce6b238037c0d$var$_AssistantStream_messageSnapshots, "f")[accumulatedMessage.id] = accumulatedMessage;
    ...
    switch(event.event){
        ...
        case "thread.message.delta":
            ...
            if (event.data.delta.content) for (const content of event.data.delta.content){
                ...
                if (content.index != $87cce6b238037c0d$var$__classPrivateFieldGet(this, $87cce6b238037c0d$var$_AssistantStream_currentContentIndex, "f")) {
                    //See if we have in progress content
                    if ($87cce6b238037c0d$var$__classPrivateFieldGet(this, $87cce6b238037c0d$var$_AssistantStream_currentContent, "f")) switch($87cce6b238037c0d$var$__classPrivateFieldGet(this, $87cce6b238037c0d$var$_AssistantStream_currentContent, "f").type){
                        case "text":
                            this._emit("textDone", $87cce6b238037c0d$var$__classPrivateFieldGet(this, $87cce6b238037c0d$var$_AssistantStream_currentContent, "f").text, $87cce6b238037c0d$var$__classPrivateFieldGet(this, $87cce6b238037c0d$var$_AssistantStream_messageSnapshot, "f"));
                            break;
                        case "image_file":
                            this._emit("imageFileDone", $87cce6b238037c0d$var$__classPrivateFieldGet(this, $87cce6b238037c0d$var$_AssistantStream_currentContent, "f").image_file, $87cce6b238037c0d$var$__classPrivateFieldGet(this, $87cce6b238037c0d$var$_AssistantStream_messageSnapshot, "f"));
                            break;
                    }
                    $87cce6b238037c0d$var$__classPrivateFieldSet(this, $87cce6b238037c0d$var$_AssistantStream_currentContentIndex, content.index, "f");
                }
                $87cce6b238037c0d$var$__classPrivateFieldSet(this, $87cce6b238037c0d$var$_AssistantStream_currentContent, accumulatedMessage.content[content.index], "f");
            }
            break;
        case "thread.message.completed":
        case "thread.message.incomplete":
            //We emit the latest content we were working on on completion (including incomplete)
            if ($87cce6b238037c0d$var$__classPrivateFieldGet(this, $87cce6b238037c0d$var$_AssistantStream_currentContentIndex, "f") !== undefined) {
                const currentContent = event.data.content[$87cce6b238037c0d$var$__classPrivateFieldGet(this, $87cce6b238037c0d$var$_AssistantStream_currentContentIndex, "f")];
                if (currentContent) switch(currentContent.type){
                    case "image_file":
                        this._emit("imageFileDone", currentContent.image_file, $87cce6b238037c0d$var$__classPrivateFieldGet(this, $87cce6b238037c0d$var$_AssistantStream_messageSnapshot, "f"));
                        break;
                    case "text":
                        this._emit("textDone", currentContent.text, $87cce6b238037c0d$var$__classPrivateFieldGet(this, $87cce6b238037c0d$var$_AssistantStream_messageSnapshot, "f"));
                        break;
                }
            }
            if ($87cce6b238037c0d$var$__classPrivateFieldGet(this, $87cce6b238037c0d$var$_AssistantStream_messageSnapshot, "f")) this._emit("messageDone", event.data);
            $87cce6b238037c0d$var$__classPrivateFieldSet(this, $87cce6b238037c0d$var$_AssistantStream_messageSnapshot, undefined, "f");
    }
}, $87cce6b238037c0d$var$_AssistantStream_handleRunStep = function _AssistantStream_handleRunStep(event) {
    const accumulatedRunStep = $87cce6b238037c0d$var$__classPrivateFieldGet(this, $87cce6b238037c0d$var$_AssistantStream_instances, "m", $87cce6b238037c0d$var$_AssistantStream_accumulateRunStep).call(this, event);
    $87cce6b238037c0d$var$__classPrivateFieldSet(this, $87cce6b238037c0d$var$_AssistantStream_currentRunStepSnapshot, accumulatedRunStep, "f");
    switch(event.event){
        case "thread.run.step.created":
        ...
        case "thread.run.step.delta":
            ...
            if (delta.step_details && delta.step_details.type == "tool_calls" && delta.step_details.tool_calls && accumulatedRunStep.step_details.type == "tool_calls") {
                for (const toolCall of delta.step_details.tool_calls)if (toolCall.index == $87cce6b238037c0d$var$__classPrivateFieldGet(this, $87cce6b238037c0d$var$_AssistantStream_currentToolCallIndex, "f")) this._emit("toolCallDelta", toolCall, accumulatedRunStep.step_details.tool_calls[toolCall.index]);
                else {
                    if ($87cce6b238037c0d$var$__classPrivateFieldGet(this, $87cce6b238037c0d$var$_AssistantStream_currentToolCall, "f")) this._emit("toolCallDone", $87cce6b238037c0d$var$__classPrivateFieldGet(this, $87cce6b238037c0d$var$_AssistantStream_currentToolCall, "f"));
                    $87cce6b238037c0d$var$__classPrivateFieldSet(this, $87cce6b238037c0d$var$_AssistantStream_currentToolCallIndex, toolCall.index, "f");
                    $87cce6b238037c0d$var$__classPrivateFieldSet(this, $87cce6b238037c0d$var$_AssistantStream_currentToolCall, accumulatedRunStep.step_details.tool_calls[toolCall.index], "f");
                    if ($87cce6b238037c0d$var$__classPrivateFieldGet(this, $87cce6b238037c0d$var$_AssistantStream_currentToolCall, "f")) this._emit("toolCallCreated", $87cce6b238037c0d$var$__classPrivateFieldGet(this, $87cce6b238037c0d$var$_AssistantStream_currentToolCall, "f"));
                }
            }
        ...
        case "thread.run.step.cancelled":
        case "thread.run.step.expired":
            $87cce6b238037c0d$var$__classPrivateFieldSet(this, $87cce6b238037c0d$var$_AssistantStream_currentRunStepSnapshot, undefined, "f");
            const details = event.data.step_details;
            if (details.type == "tool_calls") {
                if ($87cce6b238037c0d$var$__classPrivateFieldGet(this, $87cce6b238037c0d$var$_AssistantStream_currentToolCall, "f")) {
                    this._emit("toolCallDone", $87cce6b238037c0d$var$__classPrivateFieldGet(this, $87cce6b238037c0d$var$_AssistantStream_currentToolCall, "f"));
                    $87cce6b238037c0d$var$__classPrivateFieldSet(this, $87cce6b238037c0d$var$_AssistantStream_currentToolCall, undefined, "f");
                }
            }
...
}, $87cce6b238037c0d$var$_AssistantStream_handleEvent = function _AssistantStream_handleEvent(event) {
    $87cce6b238037c0d$var$__classPrivateFieldGet(this, $87cce6b238037c0d$var$_AssistantStream_events, "f").push(event);
    this._emit("event", event);
}, $87cce6b238037c0d$var$_AssistantStream_accumulateRunStep = function _AssistantStream_accumulateRunStep(event) {
    switch(event.event){
        case "thread.run.step.created":
            $87cce6b238037c0d$var$__classPrivateFieldGet(this, $87cce6b238037c0d$var$_AssistantStream_runStepSnapshots, "f")[event.data.id] = event.data;
            return event.data;
        case "thread.run.step.delta":
            let snapshot = $87cce6b238037c0d$var$__classPrivateFieldGet(this, $87cce6b238037c0d$var$_AssistantStream_runStepSnapshots, "f")[event.data.id];
            if (!snapshot) throw Error("Received a RunStepDelta before creation of a snapshot");
            let data = event.data;
            if (data.delta) {
                const accumulated = $87cce6b238037c0d$var$AssistantStream.accumulateDelta(snapshot, data.delta);
                $87cce6b238037c0d$var$__classPrivateFieldGet(this, $87cce6b238037c0d$var$_AssistantStream_runStepSnapshots, "f")[event.data.id] = accumulated;
            }
            return $87cce6b238037c0d$var$__classPrivateFieldGet(this, $87cce6b238037c0d$var$_AssistantStream_runStepSnapshots, "f")[event.data.id];
        case "thread.run.step.completed":
        case "thread.run.step.failed":
        case "thread.run.step.cancelled":
        case "thread.run.step.expired":
    ...
    if ($87cce6b238037c0d$var$__classPrivateFieldGet(this, $87cce6b238037c0d$var$_AssistantStream_runStepSnapshots, "f")[event.data.id]) return $87cce6b238037c0d$var$__classPrivateFieldGet(this, $87cce6b238037c0d$var$_AssistantStream_runStepSnapshots, "f")[event.data.id];
    throw new Error("No snapshot available");
}, $87cce6b238037c0d$var$_AssistantStream_accumulateMessage = function _AssistantStream_accumulateMessage(event, snapshot) {
    let newContent = [];
    switch(event.event){
        case "thread.message.created":
        ...
        case "thread.message.delta":
            ...
            if (data.delta.content) {
                for (const contentElement of data.delta.content)if (contentElement.index in snapshot.content) {
                    ...
                    snapshot.content[contentElement.index] = $87cce6b238037c0d$var$__classPrivateFieldGet(this, $87cce6b238037c0d$var$_AssistantStream_instances, "m", $87cce6b238037c0d$var$_AssistantStream_accumulateContent).call(this, contentElement, currentContent);
                } else {
...
}, $87cce6b238037c0d$var$_AssistantStream_accumulateContent = function _AssistantStream_accumulateContent(contentElement, currentContent) {
    return $87cce6b238037c0d$var$AssistantStream.accumulateDelta(currentContent, contentElement);
}, $87cce6b238037c0d$var$_AssistantStream_handleRun = function _AssistantStream_handleRun(event) {
    $87cce6b238037c0d$var$__classPrivateFieldSet(this, $87cce6b238037c0d$var$_AssistantStream_currentRunSnapshot, event.data, "f");
    switch(event.event){
        case "thread.run.created":
            break;
        case "thread.run.queued":
        ...
        case "thread.run.completed":
        case "thread.run.expired":
            $87cce6b238037c0d$var$__classPrivateFieldSet(this, $87cce6b238037c0d$var$_AssistantStream_finalRun, event.data, "f");
            if ($87cce6b238037c0d$var$__classPrivateFieldGet(this, $87cce6b238037c0d$var$_AssistantStream_currentToolCall, "f")) {
                this._emit("toolCallDone", $87cce6b238037c0d$var$__classPrivateFieldGet(this, $87cce6b238037c0d$var$_AssistantStream_currentToolCall, "f"));
                $87cce6b238037c0d$var$__classPrivateFieldSet(this, $87cce6b238037c0d$var$_AssistantStream_currentToolCall, undefined, "f");
            }
...
class $1e98f620f163d7e2$var$Messages extends $dQuSh.APIResource {
    ...
    list(threadId, query = {}, options) {
        ...
        return this._client.getAPIList(`/threads/${threadId}/messages`, $1e98f620f163d7e2$var$MessagesPage, {
            query: query,
            ...options,
            headers: {
                "OpenAI-Beta": "assistants=v2",
...
"use strict";
// File generated from our OpenAPI spec by Stainless. See CONTRIBUTING.md for details.
var $fbeb8ea20753d3bf$var$__createBinding = module.exports && module.exports.__createBinding || (Object.create ? function(o, m, k, k2) {
    if (k2 === undefined) k2 = k;
    var desc = Object.getOwnPropertyDescriptor(m, k);
    if (!desc || ("get" in desc ? !m.__esModule : desc.writable || desc.configurable)) desc = {
        enumerable: true,
...
var $fbeb8ea20753d3bf$var$__setModuleDefault = module.exports && module.exports.__setModuleDefault || (Object.create ? function(o, v) {
    Object.defineProperty(o, "default", {
        enumerable: true,
        value: v
    });
...
var $fbeb8ea20753d3bf$var$__importStar = module.exports && module.exports.__importStar || function(mod) {
    if (mod && mod.__esModule) return mod;
    var result = {};
    if (mod != null) {
        for(var k in mod)if (k !== "default" && Object.prototype.hasOwnProperty.call(mod, k)) $fbeb8ea20753d3bf$var$__createBinding(result, mod, k);
    }
...
class $fbeb8ea20753d3bf$var$Runs extends $dQuSh.APIResource {
     ...
     */ createAndStream(threadId, body, options) {
        return $bERsK.AssistantStream.createAssistantStream(threadId, this._client.beta.threads.runs, body, options);
    }
    /**
     ...
     */ submitToolOutputsStream(threadId, runId, body, options) {
        return $bERsK.AssistantStream.createToolAssistantStream(threadId, runId, this._client.beta.threads.runs, body, options);
    }
}
...
class $661dd2c19e00eb05$var$Steps extends $dQuSh.APIResource {
    retrieve(threadId, runId, stepId, query = {}, options) {
        if ((0, $25F7z.isRequestOptions)(query)) return this.retrieve(threadId, runId, stepId, {}, query);
    ...
    list(threadId, runId, query = {}, options) {
        ...
        return this._client.getAPIList(`/threads/${threadId}/runs/${runId}/steps`, $661dd2c19e00eb05$var$RunStepsPage, {
            query: query,
            ...options,
            headers: {
                "OpenAI-Beta": "assistants=v2",
...
"use strict";
// File generated from our OpenAPI spec by Stainless. See CONTRIBUTING.md for details.
var $2e2c7277863a2122$var$__createBinding = module.exports && module.exports.__createBinding || (Object.create ? function(o, m, k, k2) {
    if (k2 === undefined) k2 = k;
    var desc = Object.getOwnPropertyDescriptor(m, k);
    if (!desc || ("get" in desc ? !m.__esModule : desc.writable || desc.configurable)) desc = {
        enumerable: true,
...
var $2e2c7277863a2122$var$__setModuleDefault = module.exports && module.exports.__setModuleDefault || (Object.create ? function(o, v) {
    Object.defineProperty(o, "default", {
        enumerable: true,
        value: v
    });
...
var $2e2c7277863a2122$var$__importStar = module.exports && module.exports.__importStar || function(mod) {
    if (mod && mod.__esModule) return mod;
    var result = {};
    if (mod != null) {
        for(var k in mod)if (k !== "default" && Object.prototype.hasOwnProperty.call(mod, k)) $2e2c7277863a2122$var$__createBinding(result, mod, k);
    }
...
const $2e2c7277863a2122$var$FileBatchesAPI = $2e2c7277863a2122$var$__importStar((parcelRequire("l8t6R")));
...
$2e2c7277863a2122$var$VectorStores.VectorStoreFilesPage = (parcelRequire("kPJFU")).VectorStoreFilesPage;
...
class $f630ece2ce911e35$var$FileBatches extends $dQuSh.APIResource {
    ...
    listFiles(vectorStoreId, batchId, query = {}, options) {
        if ((0, $25F7z.isRequestOptions)(query)) return this.listFiles(vectorStoreId, batchId, {}, query);
        return this._client.getAPIList(`/vector_stores/${vectorStoreId}/file_batches/${batchId}/files`, $kPJFU.VectorStoreFilesPage, {
            query: query,
            ...options,
            headers: {
                "OpenAI-Beta": "assistants=v2",
...
class $f2ac002bc13fa65c$var$Files extends $dQuSh.APIResource {
    ...
    list(vectorStoreId, query = {}, options) {
        ...
        return this._client.getAPIList(`/vector_stores/${vectorStoreId}/files`, $f2ac002bc13fa65c$var$VectorStoreFilesPage, {
            query: query,
            ...options,
            headers: {
                "OpenAI-Beta": "assistants=v2",
...
"use strict";
// File generated from our OpenAPI spec by Stainless. See CONTRIBUTING.md for details.
var $12bdb48cc4f506e0$var$__createBinding = module.exports && module.exports.__createBinding || (Object.create ? function(o, m, k, k2) {
    if (k2 === undefined) k2 = k;
    var desc = Object.getOwnPropertyDescriptor(m, k);
    if (!desc || ("get" in desc ? !m.__esModule : desc.writable || desc.configurable)) desc = {
        enumerable: true,
...
var $12bdb48cc4f506e0$var$__setModuleDefault = module.exports && module.exports.__setModuleDefault || (Object.create ? function(o, v) {
    Object.defineProperty(o, "default", {
        enumerable: true,
        value: v
    });
...
var $12bdb48cc4f506e0$var$__importStar = module.exports && module.exports.__importStar || function(mod) {
    if (mod && mod.__esModule) return mod;
    var result = {};
    if (mod != null) {
        for(var k in mod)if (k !== "default" && Object.prototype.hasOwnProperty.call(mod, k)) $12bdb48cc4f506e0$var$__createBinding(result, mod, k);
    }
...
class $12bdb48cc4f506e0$var$Files extends $dQuSh.APIResource {
     ...
     * storage limits.
     */ create(body, options) {
        return this._client.post("/files", $12bdb48cc4f506e0$var$Core.multipartFormRequestOptions({
            body: body,
            ...options
        }));
    }
     ...
     */ async waitForProcessing(id, { pollInterval: pollInterval = 5000, maxWait: maxWait = 1800000 } = {}) {
        ...
        while(!file.status || !TERMINAL_STATES.has(file.status)){
            ...
            if (Date.now() - start > maxWait) throw new $eK9Mf.APIConnectionTimeoutError({
...
"use strict";
// File generated from our OpenAPI spec by Stainless. See CONTRIBUTING.md for details.
var $668cceb311513214$var$__createBinding = module.exports && module.exports.__createBinding || (Object.create ? function(o, m, k, k2) {
    if (k2 === undefined) k2 = k;
    var desc = Object.getOwnPropertyDescriptor(m, k);
    if (!desc || ("get" in desc ? !m.__esModule : desc.writable || desc.configurable)) desc = {
        enumerable: true,
...
var $668cceb311513214$var$__setModuleDefault = module.exports && module.exports.__setModuleDefault || (Object.create ? function(o, v) {
    Object.defineProperty(o, "default", {
        enumerable: true,
        value: v
    });
...
var $668cceb311513214$var$__importStar = module.exports && module.exports.__importStar || function(mod) {
    if (mod && mod.__esModule) return mod;
    var result = {};
    if (mod != null) {
        for(var k in mod)if (k !== "default" && Object.prototype.hasOwnProperty.call(mod, k)) $668cceb311513214$var$__createBinding(result, mod, k);
    }
...
$668cceb311513214$var$FineTuning.FineTuningJobEventsPage = (parcelRequire("cB42p")).FineTuningJobEventsPage;

});
parcelRegister("cB42p", function(module, exports) {
"use strict";
// File generated from our OpenAPI spec by Stainless. See CONTRIBUTING.md for details.
var $92bc1291e2258b8d$var$__createBinding = module.exports && module.exports.__createBinding || (Object.create ? function(o, m, k, k2) {
    if (k2 === undefined) k2 = k;
    var desc = Object.getOwnPropertyDescriptor(m, k);
    if (!desc || ("get" in desc ? !m.__esModule : desc.writable || desc.configurable)) desc = {
        enumerable: true,
...
var $92bc1291e2258b8d$var$__setModuleDefault = module.exports && module.exports.__setModuleDefault || (Object.create ? function(o, v) {
    Object.defineProperty(o, "default", {
        enumerable: true,
        value: v
    });
...
var $92bc1291e2258b8d$var$__importStar = module.exports && module.exports.__importStar || function(mod) {
    if (mod && mod.__esModule) return mod;
    var result = {};
    if (mod != null) {
        for(var k in mod)if (k !== "default" && Object.prototype.hasOwnProperty.call(mod, k)) $92bc1291e2258b8d$var$__createBinding(result, mod, k);
    }
...
const $92bc1291e2258b8d$var$CheckpointsAPI = $92bc1291e2258b8d$var$__importStar((parcelRequire("01pKw")));
...
class $92bc1291e2258b8d$var$Jobs extends $dQuSh.APIResource {
    ...
    list(query = {}, options) {
        if ((0, $25F7z.isRequestOptions)(query)) return this.list({}, query);
        return this._client.getAPIList("/fine_tuning/jobs", $92bc1291e2258b8d$var$FineTuningJobsPage, {
            query: query,
            ...options
        });
    }
    ...
    listEvents(fineTuningJobId, query = {}, options) {
        ...
        return this._client.getAPIList(`/fine_tuning/jobs/${fineTuningJobId}/events`, $92bc1291e2258b8d$var$FineTuningJobEventsPage, {
            query: query,
            ...options
        });
    }
...
$92bc1291e2258b8d$var$Jobs.FineTuningJobEventsPage = $92bc1291e2258b8d$var$FineTuningJobEventsPage;
$92bc1291e2258b8d$var$Jobs.Checkpoints = (parcelRequire("01pKw")).Checkpoints;
$92bc1291e2258b8d$var$Jobs.FineTuningJobCheckpointsPage = (parcelRequire("01pKw")).FineTuningJobCheckpointsPage;
...
class $00441161b18af9db$var$Checkpoints extends $dQuSh.APIResource {
    list(fineTuningJobId, query = {}, options) {
        ...
        return this._client.getAPIList(`/fine_tuning/jobs/${fineTuningJobId}/checkpoints`, $00441161b18af9db$var$FineTuningJobCheckpointsPage, {
            query: query,
            ...options
        });
    }
...
$00441161b18af9db$var$Checkpoints.FineTuningJobCheckpointsPage = $00441161b18af9db$var$FineTuningJobCheckpointsPage;
...
"use strict";
// File generated from our OpenAPI spec by Stainless. See CONTRIBUTING.md for details.
var $e93a4e0dbf310376$var$__createBinding = module.exports && module.exports.__createBinding || (Object.create ? function(o, m, k, k2) {
    if (k2 === undefined) k2 = k;
    var desc = Object.getOwnPropertyDescriptor(m, k);
    if (!desc || ("get" in desc ? !m.__esModule : desc.writable || desc.configurable)) desc = {
        enumerable: true,
...
var $e93a4e0dbf310376$var$__setModuleDefault = module.exports && module.exports.__setModuleDefault || (Object.create ? function(o, v) {
    Object.defineProperty(o, "default", {
        enumerable: true,
        value: v
    });
...
var $e93a4e0dbf310376$var$__importStar = module.exports && module.exports.__importStar || function(mod) {
    if (mod && mod.__esModule) return mod;
    var result = {};
    if (mod != null) {
        for(var k in mod)if (k !== "default" && Object.prototype.hasOwnProperty.call(mod, k)) $e93a4e0dbf310376$var$__createBinding(result, mod, k);
    }
...
class $e93a4e0dbf310376$var$Images extends $dQuSh.APIResource {
     ...
     */ createVariation(body, options) {
        return this._client.post("/images/variations", $e93a4e0dbf310376$var$Core.multipartFormRequestOptions({
            body: body,
            ...options
        }));
    }
     ...
     */ edit(body, options) {
        return this._client.post("/images/edits", $e93a4e0dbf310376$var$Core.multipartFormRequestOptions({
            body: body,
            ...options
        }));
    }
...
"use strict";
// File generated from our OpenAPI spec by Stainless. See CONTRIBUTING.md for details.
var $652b929027abc918$var$__createBinding = module.exports && module.exports.__createBinding || (Object.create ? function(o, m, k, k2) {
    if (k2 === undefined) k2 = k;
    var desc = Object.getOwnPropertyDescriptor(m, k);
    if (!desc || ("get" in desc ? !m.__esModule : desc.writable || desc.configurable)) desc = {
        enumerable: true,
...
var $652b929027abc918$var$__setModuleDefault = module.exports && module.exports.__setModuleDefault || (Object.create ? function(o, v) {
    Object.defineProperty(o, "default", {
        enumerable: true,
        value: v
    });
...
var $652b929027abc918$var$__importStar = module.exports && module.exports.__importStar || function(mod) {
    if (mod && mod.__esModule) return mod;
    var result = {};
    if (mod != null) {
        for(var k in mod)if (k !== "default" && Object.prototype.hasOwnProperty.call(mod, k)) $652b929027abc918$var$__createBinding(result, mod, k);
    }
...
"use strict";
// File generated from our OpenAPI spec by Stainless. See CONTRIBUTING.md for details.
var $d7d29dc47e795fdd$var$__createBinding = module.exports && module.exports.__createBinding || (Object.create ? function(o, m, k, k2) {
    if (k2 === undefined) k2 = k;
    var desc = Object.getOwnPropertyDescriptor(m, k);
    if (!desc || ("get" in desc ? !m.__esModule : desc.writable || desc.configurable)) desc = {
        enumerable: true,
...
var $d7d29dc47e795fdd$var$__setModuleDefault = module.exports && module.exports.__setModuleDefault || (Object.create ? function(o, v) {
    Object.defineProperty(o, "default", {
        enumerable: true,
        value: v
    });
...
var $d7d29dc47e795fdd$var$__importStar = module.exports && module.exports.__importStar || function(mod) {
    if (mod && mod.__esModule) return mod;
    var result = {};
    if (mod != null) {
        for(var k in mod)if (k !== "default" && Object.prototype.hasOwnProperty.call(mod, k)) $d7d29dc47e795fdd$var$__createBinding(result, mod, k);
    }
...
class $d7d29dc47e795fdd$var$Parts extends $dQuSh.APIResource {
     ...
     */ create(uploadId, body, options) {
        return this._client.post(`/uploads/${uploadId}/parts`, $d7d29dc47e795fdd$var$Core.multipartFormRequestOptions({
            body: body,
            ...options
        }));
    }
...
function $03f88873f2eb1182$export$12c9a8e00b0aa2d3(shims, options = {
    auto: false
}) {
    if ($03f88873f2eb1182$export$dfb5619354ba860) throw new Error(`you must \`import 'openai/shims/${shims.kind}'\` before importing anything else from openai`);
    if ($03f88873f2eb1182$export$78062f36b16ed2f8) throw new Error(`can't \`import 'openai/shims/${shims.kind}'\` after \`import 'openai/shims/${$03f88873f2eb1182$export$78062f36b16ed2f8}'\``);
...
if (!$03f88873f2eb1182$export$78062f36b16ed2f8) $03f88873f2eb1182$export$12c9a8e00b0aa2d3($5c3619e301880096$export$5fcd68b67c93ed4a(), {
    auto: true
});
...
class $15833e56ae61e84b$export$e74e3e334b3894e3 {
    ...
    decode(chunk) {
        ...
        if (!text) return [];
        const trailingNewline = $15833e56ae61e84b$export$e74e3e334b3894e3.NEWLINE_CHARS.has(text[text.length - 1] || "");
    ...
    decodeText(bytes) {
        ...
        if (typeof Buffer !== "undefined") {
            if (bytes instanceof Buffer) return bytes.toString();
            if (bytes instanceof Uint8Array) return Buffer.from(bytes).toString();
            throw new (0, $35a995371031c9b0$export$7668a15b8d9a0caa)(`Unexpected: received non-Uint8Array (${bytes.constructor.name}) stream chunk in an environment with a global "Buffer" defined, which this library assumes to be Node. Please report this error.`);
        }
        // Browser
        if (typeof TextDecoder !== "undefined") {
            if (bytes instanceof Uint8Array || bytes instanceof ArrayBuffer) {
            ...
            throw new (0, $35a995371031c9b0$export$7668a15b8d9a0caa)(`Unexpected: received non-Uint8Array/ArrayBuffer (${bytes.constructor.name}) in a web platform. Please report this error.`);
        }
        throw new (0, $35a995371031c9b0$export$7668a15b8d9a0caa)(`Unexpected: neither Buffer nor TextDecoder are available as globals. Please report this error.`);
    }
    flush() {
        if (!this.buffer.length && !this.trailingCR) return [];
        const lines = [
            ...
            try {
                for await (const sse of $c4a70f48b7b88780$export$de202fb52edf78c0(response, controller)){
                    ...
                    if (sse.event === null) {
                        ...
                        if (data && data.error) throw new (0, $35a995371031c9b0$export$3e5b797e39668f84)(undefined, data.error, undefined, undefined);
                        yield data;
                    } else {
                        let data;
                        try {
                        ...
                        // TODO: Is this where the error should be thrown?
                        if (sse.event == "error") throw new (0, $35a995371031c9b0$export$3e5b797e39668f84)(undefined, data.error, data.message, undefined);
                        yield {
                            event: sse.event,
                            data: data
                        };
...
async function* $c4a70f48b7b88780$export$de202fb52edf78c0(response, controller) {
    if (!response.body) {
        controller.abort();
        throw new (0, $35a995371031c9b0$export$7668a15b8d9a0caa)(`Attempted to iterate over a response with no body`);
    }
    const sseDecoder = new $c4a70f48b7b88780$var$SSEDecoder();
    const lineDecoder = new (0, $15833e56ae61e84b$export$e74e3e334b3894e3)();
    const iter = $c4a70f48b7b88780$export$5ac880445c73c5f8(response.body);
    for await (const sseChunk of $c4a70f48b7b88780$var$iterSSEChunks(iter))for (const line of lineDecoder.decode(sseChunk)){
        const sse = sseDecoder.decode(line);
        if (sse) yield sse;
    }
    for (const line of lineDecoder.flush()){
...
const $26f22d17388f03c8$export$db1b38f0e0e0d735 = (value)=>value != null && typeof value === "object" && typeof value.url === "string" && typeof value.blob === "function";
const $26f22d17388f03c8$export$f523b67034c5a6de = (value)=>value != null && typeof value === "object" && typeof value.name === "string" && typeof value.lastModified === "number" && $26f22d17388f03c8$export$5c3b3b90b547c112(value);
const $26f22d17388f03c8$export$5c3b3b90b547c112 = (value)=>value != null && typeof value === "object" && typeof value.size === "number" && typeof value.type === "string" && typeof value.text === "function" && typeof value.slice === "function" && typeof value.arrayBuffer === "function";
const $26f22d17388f03c8$export$291c899f7ea4e64e = (value)=>{
    return $26f22d17388f03c8$export$f523b67034c5a6de(value) || $26f22d17388f03c8$export$db1b38f0e0e0d735(value) || (0, $03f88873f2eb1182$export$bb863823a5a2fbbe)(value);
};
...
async function $26f22d17388f03c8$var$getBytes(value) {
    ...
    else if ($26f22d17388f03c8$var$isAsyncIterableIterator(value) // includes Readable, ReadableStream, etc.
    ) for await (const chunk of value)parts.push(chunk); // TODO, consider validating?
    else throw new Error(`Unexpected data type: ${typeof value}; constructor: ${value?.constructor?.name}; props: ${$26f22d17388f03c8$var$propsForError(value)}`);
    return parts;
}
...
function $26f22d17388f03c8$var$getName(value) {
    return $26f22d17388f03c8$var$getStringFromMaybeBuffer(value.name) || $26f22d17388f03c8$var$getStringFromMaybeBuffer(value.filename) || // For fs.ReadStream
...
const $26f22d17388f03c8$var$isAsyncIterableIterator = (value)=>value != null && typeof value === "object" && typeof value[Symbol.asyncIterator] === "function";
const $26f22d17388f03c8$export$669ddb8d269579e7 = (body)=>body && typeof body === "object" && body.body && body[Symbol.toStringTag] === "MultipartBody";
...
const $26f22d17388f03c8$export$f681a8129d2e9d28 = async (body)=>{
    ...
    await Promise.all(Object.entries(body || {}).map(([key, value])=>$26f22d17388f03c8$var$addFormValue(form, key, value)));
    return form;
};
...
const $26f22d17388f03c8$var$addFormValue = async (form, key, value)=>{
    ...
    if (typeof value === "string" || typeof value === "number" || typeof value === "boolean") form.append(key, String(value));
        ...
        form.append(key, file);
    } else if (Array.isArray(value)) await Promise.all(value.map((entry)=>$26f22d17388f03c8$var$addFormValue(form, key + "[]", entry)));
    else if (typeof value === "object") await Promise.all(Object.entries(value).map(([name, prop])=>$26f22d17388f03c8$var$addFormValue(form, `${key}[${name}]`, prop)));
    else throw new TypeError(`Invalid value given to form, expected a string, number, boolean, object, Array, File or Blob but got ${value} instead`);
};


var $80331b378f26e884$var$__classPrivateFieldSet = undefined && undefined.__classPrivateFieldSet || function(receiver, state, value, kind, f) {
    if (kind === "m") throw new TypeError("Private method is not writable");
    if (kind === "a" && !f) throw new TypeError("Private accessor was defined without a setter");
    if (typeof state === "function" ? receiver !== state || !f : !state.has(receiver)) throw new TypeError("Cannot write private member to an object whose class did not declare it");
    return kind === "a" ? f.call(receiver, value) : f ? f.value = value : state.set(receiver, value), value;
};
var $80331b378f26e884$var$__classPrivateFieldGet = undefined && undefined.__classPrivateFieldGet || function(receiver, state, kind, f) {
    if (kind === "a" && !f) throw new TypeError("Private accessor was defined without a getter");
    if (typeof state === "function" ? receiver !== state || !f : !state.has(receiver)) throw new TypeError("Cannot read private member from an object whose class did not declare it");
    return kind === "m" ? f : kind === "a" ? f.call(receiver) : f ? f.value : state.get(receiver);
};
...
async function $80331b378f26e884$var$defaultParseResponse(props) {
    const { response: response } = props;
    if (props.options.stream) {
        $80331b378f26e884$export$1c9f709888824e05("response", response.status, response.url, response.headers, response.body);
        // Note: there is an invariant here that isn't represented in the type system
        // that if you set `stream: true` the response type must also be `Stream<T>`
        if (props.options.__streamClass) return props.options.__streamClass.fromSSEResponse(response, props.controller);
        return (0, $c4a70f48b7b88780$export$6a4eb2e7fc9e8903).fromSSEResponse(response, props.controller);
    }
    // fetch refuses to read the body when the status code is 204.
    if (response.status === 204) return null;
    if (props.options.__binaryResponse) return response;
    ...
    if (isJSON) {
        const json = await response.json();
        $80331b378f26e884$export$1c9f709888824e05("response", response.status, response.url, response.headers, json);
        return $80331b378f26e884$var$_addRequestID(json, response);
    }
    const text = await response.text();
    $80331b378f26e884$export$1c9f709888824e05("response", response.status, response.url, response.headers, text);
    // TODO handle blob, arraybuffer, other content types, etc.
    return text;
}
...
class $80331b378f26e884$export$6d81b1be6cb81bf2 extends Promise {
    ...
    _thenUnwrap(transform) {
        return new $80331b378f26e884$export$6d81b1be6cb81bf2(this.responsePromise, async (props)=>$80331b378f26e884$var$_addRequestID(transform(await this.parseResponse(props), props), props.response));
    }
    /**
     * Gets the raw `Response` instance instead of parsing the response
     * data.
...
class $80331b378f26e884$export$90436f47e91435f2 {
    ...
    methodRequest(method, path, opts) {
        return this.request(Promise.resolve(opts).then(async (opts)=>{
            const body = opts && (0, $26f22d17388f03c8$export$5c3b3b90b547c112)(opts?.body) ? new DataView(await opts.body.arrayBuffer()) : opts?.body instanceof DataView ? opts.body : opts?.body instanceof ArrayBuffer ? new DataView(opts.body) : opts && ArrayBuffer.isView(opts?.body) ? new DataView(opts.body.buffer) : opts?.body;
            return {
                method: method,
                path: path,
                ...opts,
    ...
    buildRequest(options, { retryCount: retryCount = 0 } = {}) {
        const { method: method, path: path, query: query, headers: headers = {} } = options;
        const body = ArrayBuffer.isView(options.body) || options.__binaryRequest && typeof options.body === "string" ? options.body : (0, $26f22d17388f03c8$export$669ddb8d269579e7)(options.body) ? options.body.body : options.body ? JSON.stringify(options.body, null, 2) : null;
        const contentLength = this.calculateContentLength(body);
        const url = this.buildURL(path, query);
        if ("timeout" in options) $80331b378f26e884$var$validatePositiveInteger("timeout", options.timeout);
        const timeout = options.timeout ?? this.timeout;
        const httpAgent = options.httpAgent ?? this.httpAgent ?? (0, $03f88873f2eb1182$export$4430d10c2e71ce6c)(url);
        const minAgentTimeout = timeout + 1000;
        if (typeof httpAgent?.options?.timeout === "number" && minAgentTimeout > (httpAgent.options.timeout ?? 0)) // Allow any given request to bump our agent active socket timeout.
        // This may seem strange, but leaking active sockets should be rare and not particularly problematic,
        // and without mutating agent we would need to create more of them.
    ...
    buildHeaders({ options: options, headers: headers, contentLength: contentLength, retryCount: retryCount }) {
        ...
        // let builtin fetch set the Content-Type for multipart bodies
        if ((0, $26f22d17388f03c8$export$669ddb8d269579e7)(options.body) && (0, $03f88873f2eb1182$export$78062f36b16ed2f8) !== "node") delete reqHeaders["content-type"];
        // Don't set the retry count header if it was already set or removed through default headers or by the
        // caller. We check `defaultHeaders` and `headers`, which can contain nulls, instead of `reqHeaders` to
        // account for the removal case.
        if ($80331b378f26e884$export$47ed31abc613cf55(defaultHeaders, "x-stainless-retry-count") === undefined && $80331b378f26e884$export$47ed31abc613cf55(headers, "x-stainless-retry-count") === undefined) reqHeaders["x-stainless-retry-count"] = String(retryCount);
        this.validateHeaders(reqHeaders, headers);
        return reqHeaders;
    }
    /**
    ...
    request(options, remainingRetries = null) {
        return new $80331b378f26e884$export$6d81b1be6cb81bf2(this.makeRequest(options, remainingRetries));
    }
    async makeRequest(optionsInput, retriesRemaining) {
        const options = await optionsInput;
        const maxRetries = options.maxRetries ?? this.maxRetries;
        ...
        const controller = new AbortController();
        const response = await this.fetchWithTimeout(url, req, timeout, controller).catch($80331b378f26e884$export$b2c0dd4e7376122b);
        if (response instanceof Error) {
            if (options.signal?.aborted) throw new (0, $35a995371031c9b0$export$2a26fd236aba7348)();
            if (retriesRemaining) return this.retryRequest(options, retriesRemaining);
            if (response.name === "AbortError") throw new (0, $35a995371031c9b0$export$51181302f6f4bef3)();
        ...
        if (!response.ok) {
            if (retriesRemaining && this.shouldRetry(response)) {
                const retryMessage = `retrying, ${retriesRemaining} attempts remaining`;
                $80331b378f26e884$export$1c9f709888824e05(`response (error; ${retryMessage})`, response.status, url, responseHeaders);
                return this.retryRequest(options, retriesRemaining, responseHeaders);
            }
            const errText = await response.text().catch((e)=>$80331b378f26e884$export$b2c0dd4e7376122b(e).message);
            const errJSON = $80331b378f26e884$export$7c9c6fb6298d9204(errText);
            const errMessage = errJSON ? undefined : errText;
            const retryMessage = retriesRemaining ? `(error; no more retries left)` : `(error; not retryable)`;
            $80331b378f26e884$export$1c9f709888824e05(`response (error; ${retryMessage})`, response.status, url, responseHeaders, errMessage);
            const err = this.makeStatusError(response.status, errJSON, errMessage, responseHeaders);
            throw err;
        }
        return {
    ...
    buildURL(path, query) {
        const url = $80331b378f26e884$var$isAbsoluteURL(path) ? new URL(path) : new URL(this.baseURL + (this.baseURL.endsWith("/") && path.startsWith("/") ? path.slice(1) : path));
        const defaultQuery = this.defaultQuery();
        if (!$80331b378f26e884$export$4a2fbc025e4a4a37(defaultQuery)) query = {
            ...defaultQuery,
            ...query
        };
        if (typeof query === "object" && query && !Array.isArray(query)) url.search = this.stringifyQuery(query);
    ...
    stringifyQuery(query) {
        return Object.entries(query).filter(([_, value])=>typeof value !== "undefined").map(([key, value])=>{
            if (typeof value === "string" || typeof value === "number" || typeof value === "boolean") return `${encodeURIComponent(key)}=${encodeURIComponent(value)}`;
            if (value === null) return `${encodeURIComponent(key)}=`;
            throw new (0, $35a995371031c9b0$export$7668a15b8d9a0caa)(`Cannot stringify type ${typeof value}; Expected string, number, boolean, or null. If you need to pass nested query parameters, you can manually encode them, e.g. { query: { 'foo[key1]': value1, 'foo[key2]': value2 } }, and please open a GitHub issue requesting better support for your use case.`);
        }).join("&");
    }
    async fetchWithTimeout(url, init, ms, controller) {
        const { signal: signal, ...options } = init || {};
...
class $80331b378f26e884$export$bc4ec43eb76c64ae {
    constructor(client, response, body, options){
        ...
        $80331b378f26e884$var$__classPrivateFieldSet(this, $80331b378f26e884$var$_AbstractPage_client, client, "f");
        this.options = options;
        this.response = response;
        this.body = body;
    }
    ...
    async getNextPage() {
        const nextInfo = this.nextPageInfo();
        if (!nextInfo) throw new (0, $35a995371031c9b0$export$7668a15b8d9a0caa)("No next page expected; please check `.hasNextPage()` before calling `.getNextPage()`.");
        const nextOptions = {
            ...this.options
        };
        if ("params" in nextInfo && typeof nextOptions.query === "object") nextOptions.query = {
        ...
        return await $80331b378f26e884$var$__classPrivateFieldGet(this, $80331b378f26e884$var$_AbstractPage_client, "f").requestAPIList(this.constructor, nextOptions);
    }
    async *iterPages() {
        // eslint-disable-next-line @typescript-eslint/no-this-alias
        let page = this;
...
class $80331b378f26e884$export$838875a2a6347bb extends $80331b378f26e884$export$6d81b1be6cb81bf2 {
    constructor(client, request, Page){
        super(request, async (props)=>new Page(client, props.response, await $80331b378f26e884$var$defaultParseResponse(props), props.options));
    }
    /**
     * Allow auto-paginating iteration on an unawaited list call, eg:
     *
...
const $80331b378f26e884$export$3a8c02e2928a14fc = (obj)=>{
    return typeof obj === "object" && obj !== null && !$80331b378f26e884$export$4a2fbc025e4a4a37(obj) && Object.keys(obj).every((k)=>$80331b378f26e884$export$b5a638e9b3fff9f3($80331b378f26e884$var$requestOptionsKeys, k));
};
...
const $80331b378f26e884$var$getPlatformHeaders = ()=>{
    return $80331b378f26e884$var$_platformHeaders ?? ($80331b378f26e884$var$_platformHeaders = $80331b378f26e884$var$getPlatformProperties());
};
...
const $80331b378f26e884$export$e772c8ff12451969 = (ms)=>new Promise((resolve)=>setTimeout(resolve, ms));
const $80331b378f26e884$var$validatePositiveInteger = (name, n)=>{
    if (typeof n !== "number" || !Number.isInteger(n)) throw new (0, $35a995371031c9b0$export$7668a15b8d9a0caa)(`${name} must be an integer`);
    if (n < 0) throw new (0, $35a995371031c9b0$export$7668a15b8d9a0caa)(`${name} must be a positive integer`);
    return n;
};
...
const $80331b378f26e884$export$af4c7db3845bb1c2 = (value)=>{
    if (value == null) throw new (0, $35a995371031c9b0$export$7668a15b8d9a0caa)(`Expected a value to be given but received ${value} instead.`);
    return value;
};
...
const $80331b378f26e884$export$4ecf346c64b3eb34 = (value)=>{
    if (typeof value === "number") return Math.round(value);
    if (typeof value === "string") return parseInt(value, 10);
    throw new (0, $35a995371031c9b0$export$7668a15b8d9a0caa)(`Could not coerce ${value} (type: ${typeof value}) into a number`);
};
...
const $80331b378f26e884$export$37cc283d8fbd3462 = (str)=>{
    ...
    if (typeof Buffer !== "undefined") return Buffer.from(str).toString("base64");
    if (typeof btoa !== "undefined") return btoa(str);
    throw new (0, $35a995371031c9b0$export$7668a15b8d9a0caa)("Cannot generate b64 string; Expected `Buffer` or `btoa` to be defined");
};
...
class $35a995371031c9b0$export$3e5b797e39668f84 extends $35a995371031c9b0$export$7668a15b8d9a0caa {
    ...
    static generate(status, errorResponse, message, headers) {
        if (!status) return new $35a995371031c9b0$export$74b830ad1c700a9b({
            message: message,
            cause: (0, $80331b378f26e884$export$b2c0dd4e7376122b)(errorResponse)
        });
        const error = errorResponse?.["error"];
        if (status === 400) return new $35a995371031c9b0$export$6bfa95453d427b2b(status, error, message, headers);
        if (status === 401) return new $35a995371031c9b0$export$cf0c46b07324e9c5(status, error, message, headers);
        if (status === 403) return new $35a995371031c9b0$export$9c81d48c1e1840ac(status, error, message, headers);
        if (status === 404) return new $35a995371031c9b0$export$78c95b58762d2106(status, error, message, headers);
        if (status === 409) return new $35a995371031c9b0$export$a1d6430d09a06aee(status, error, message, headers);
        if (status === 422) return new $35a995371031c9b0$export$d191fb0a9d005daf(status, error, message, headers);
        if (status === 429) return new $35a995371031c9b0$export$5db8ebadb53b7f77(status, error, message, headers);
        if (status >= 500) return new $35a995371031c9b0$export$2004b0625b599107(status, error, message, headers);
...
function $2288bd4f606a2ce7$export$cd39a28c3b357ba1(completion, params) {
    if (!params || !$2288bd4f606a2ce7$export$eeede6984aa92019(params)) return {
        ...completion,
        choices: completion.choices.map((choice)=>({
                ...choice,
                message: {
...
function $2288bd4f606a2ce7$export$bea40bc252349f06(completion, params) {
    const choices = completion.choices.map((choice)=>{
        if (choice.finish_reason === "length") throw new (0, $35a995371031c9b0$export$64d0ec7d4e7a2858)();
        if (choice.finish_reason === "content_filter") throw new (0, $35a995371031c9b0$export$56f1bc7271a4e3c3)();
        return {
            ...choice,
            message: {
                ...choice.message,
                tool_calls: choice.message.tool_calls?.map((toolCall)=>$2288bd4f606a2ce7$var$parseToolCall(params, toolCall)) ?? [],
                parsed: choice.message.content && !choice.message.refusal ? $2288bd4f606a2ce7$var$parseResponseFormat(params, choice.message.content) : null
            }
        };
    });
    return {
...
function $2288bd4f606a2ce7$var$parseToolCall(params, toolCall) {
    ...
    return {
        ...
        function: {
            ...toolCall.function,
            parsed_arguments: $2288bd4f606a2ce7$export$cd66731d9ec8496d(inputTool) ? inputTool.$parseRaw(toolCall.function.arguments) : inputTool?.function.strict ? JSON.parse(toolCall.function.arguments) : null
        }
    };
}
function $2288bd4f606a2ce7$export$4fe91242709b72e2(params, toolCall) {
    if (!params) return false;
    const inputTool = params.tools?.find((inputTool)=>inputTool.function?.name === toolCall.function.name);
    return $2288bd4f606a2ce7$export$cd66731d9ec8496d(inputTool) || inputTool?.function.strict || false;
}
function $2288bd4f606a2ce7$export$eeede6984aa92019(params) {
    ...
    return params.tools?.some((t)=>$2288bd4f606a2ce7$export$cd66731d9ec8496d(t) || t.type === "function" && t.function.strict === true) ?? false;
}
function $2288bd4f606a2ce7$export$3ac73b33c2141c0d(tools) {
    for (const tool of tools ?? []){
        if (tool.type !== "function") throw new (0, $35a995371031c9b0$export$7668a15b8d9a0caa)(`Currently only \`function\` tool types support auto-parsing; Received \`${tool.type}\``);
        if (tool.function.strict !== true) throw new (0, $35a995371031c9b0$export$7668a15b8d9a0caa)(`The \`${tool.function.name}\` tool is not marked with \`strict: true\`. Only strict function tools can be auto-parsed`);
    }
}
...
const $294e9db24f29f2d7$export$5716da67bfaa244d = $294e9db24f29f2d7$export$7debb50ef11d5e0b.arrayToEnum([
    "string",
    "nan",
    "number",
    "integer",
...
const $294e9db24f29f2d7$export$3e9057828ebd5c7a = (data)=>{
    ...
    switch(t){
        ...
        case "number":
            return isNaN(data) ? $294e9db24f29f2d7$export$5716da67bfaa244d.nan : $294e9db24f29f2d7$export$5716da67bfaa244d.number;
        case "boolean":
        ...
        case "object":
            ...
            if (data.then && typeof data.then === "function" && data.catch && typeof data.catch === "function") return $294e9db24f29f2d7$export$5716da67bfaa244d.promise;
            if (typeof Map !== "undefined" && data instanceof Map) return $294e9db24f29f2d7$export$5716da67bfaa244d.map;
            if (typeof Set !== "undefined" && data instanceof Set) return $294e9db24f29f2d7$export$5716da67bfaa244d.set;
            if (typeof Date !== "undefined" && data instanceof Date) return $294e9db24f29f2d7$export$5716da67bfaa244d.date;
            return $294e9db24f29f2d7$export$5716da67bfaa244d.object;
        default:
            return $294e9db24f29f2d7$export$5716da67bfaa244d.unknown;
    }
};
const $294e9db24f29f2d7$export$5ba560653e4a1035 = $294e9db24f29f2d7$export$7debb50ef11d5e0b.arrayToEnum([
    "invalid_type",
    "invalid_literal",
    "custom",
    "invalid_union",
...
class $294e9db24f29f2d7$export$f98dac4b251ab333 extends Error {
    ...
    static assert(value) {
        if (!(value instanceof $294e9db24f29f2d7$export$f98dac4b251ab333)) throw new Error(`Not a ZodError: ${value}`);
    }
    toString() {
        return this.message;
    }
    get message() {
        return JSON.stringify(this.issues, $294e9db24f29f2d7$export$7debb50ef11d5e0b.jsonStringifyReplacer, 2);
    }
    get isEmpty() {
...
const $294e9db24f29f2d7$export$341b0b6e0a6f5099 = (issue, _ctx)=>{
    ...
    switch(issue.code){
        case $294e9db24f29f2d7$export$5ba560653e4a1035.invalid_type:
            if (issue.received === $294e9db24f29f2d7$export$5716da67bfaa244d.undefined) message = "Required";
...
function $294e9db24f29f2d7$export$db7caee60e5d514d(ctx, issueData) {
    ...
    const issue = $294e9db24f29f2d7$export$244a85fde9c419ed({
        ...
        errorMaps: [
            ...
            ctx.schemaErrorMap,
            overrideMap,
            overrideMap === $294e9db24f29f2d7$export$341b0b6e0a6f5099 ? undefined : $294e9db24f29f2d7$export$341b0b6e0a6f5099
        ].filter((x)=>!!x)
    });
...
const $294e9db24f29f2d7$export$aefee5ebe1dcfd9e = (x)=>typeof Promise !== "undefined" && x instanceof Promise;
/******************************************************************************
...
***************************************************************************** */ function $294e9db24f29f2d7$var$__classPrivateFieldGet(receiver, state, kind, f) {
    if (kind === "a" && !f) throw new TypeError("Private accessor was defined without a getter");
    if (typeof state === "function" ? receiver !== state || !f : !state.has(receiver)) throw new TypeError("Cannot read private member from an object whose class did not declare it");
    return kind === "m" ? f : kind === "a" ? f.call(receiver) : f ? f.value : state.get(receiver);
}
...
const $294e9db24f29f2d7$var$handleResult = (ctx, result)=>{
    if ($294e9db24f29f2d7$export$1ea939691cdc45b8(result)) return {
        success: true,
        data: result.value
    };
    else {
...
class $294e9db24f29f2d7$export$19342e026b58ebb7 {
    ...
    _parseSync(input) {
        ...
        if ($294e9db24f29f2d7$export$aefee5ebe1dcfd9e(result)) throw new Error("Synchronous parse encountered promise.");
        return result;
    }
    _parseAsync(input) {
        const result = this._parse(input);
    ...
    async safeParseAsync(data, params) {
        ...
        const result = await ($294e9db24f29f2d7$export$aefee5ebe1dcfd9e(maybeAsyncResult) ? maybeAsyncResult : Promise.resolve(maybeAsyncResult));
        return $294e9db24f29f2d7$var$handleResult(ctx, result);
    }
    ...
    or(option) {
        return $294e9db24f29f2d7$export$a8b236cb5070a311.create([
            this,
            option
        ], this._def);
    }
...
const $294e9db24f29f2d7$var$uuidRegex = /^[0-9a-fA-F]{8}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{12}$/i;
const $294e9db24f29f2d7$var$nanoidRegex = /^[a-z0-9_-]{21}$/i;
const $294e9db24f29f2d7$var$durationRegex = /^[-+]?P(?!$)(?:(?:[-+]?\d+Y)|(?:[-+]?\d+[.,]\d+Y$))?(?:(?:[-+]?\d+M)|(?:[-+]?\d+[.,]\d+M$))?(?:(?:[-+]?\d+W)|(?:[-+]?\d+[.,]\d+W$))?(?:(?:[-+]?\d+D)|(?:[-+]?\d+[.,]\d+D$))?(?:T(?=[\d+-])(?:(?:[-+]?\d+H)|(?:[-+]?\d+[.,]\d+H$))?(?:(?:[-+]?\d+M)|(?:[-+]?\d+[.,]\d+M$))?(?:[-+]?\d+(?:[.,]\d+)?S)?)??$/;
...
const $294e9db24f29f2d7$var$emailRegex = /^(?!\.)(?!.*\.\.)([A-Z0-9_'+\-\.]*)[A-Z0-9_+-]@([A-Z0-9][A-Z0-9\-]*\.)+[A-Z]{2,}$/i;
// const emailRegex =
...
const $294e9db24f29f2d7$var$ipv4Regex = /^(?:(?:25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])\.){3}(?:25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])$/;
const $294e9db24f29f2d7$var$ipv6Regex = /^(([a-f0-9]{1,4}:){7}|::([a-f0-9]{1,4}:){0,6}|([a-f0-9]{1,4}:){1}:([a-f0-9]{1,4}:){0,5}|([a-f0-9]{1,4}:){2}:([a-f0-9]{1,4}:){0,4}|([a-f0-9]{1,4}:){3}:([a-f0-9]{1,4}:){0,3}|([a-f0-9]{1,4}:){4}:([a-f0-9]{1,4}:){0,2}|([a-f0-9]{1,4}:){5}:([a-f0-9]{1,4}:){0,1})([a-f0-9]{1,4}|(((25[0-5])|(2[0-4][0-9])|(1[0-9]{2})|([0-9]{1,2}))\.){3}((25[0-5])|(2[0-4][0-9])|(1[0-9]{2})|([0-9]{1,2})))$/;
// https://stackoverflow.com/questions/7860392/determine-if-string-is-in-base64-using-javascript
const $294e9db24f29f2d7$var$base64Regex = /^([0-9a-zA-Z+/]{4})*(([0-9a-zA-Z+/]{2}==)|([0-9a-zA-Z+/]{3}=))?$/;
// simple
...
class $294e9db24f29f2d7$export$1230eb29b8d3b502 extends $294e9db24f29f2d7$export$19342e026b58ebb7 {
    _parse(input) {
        ...
        for (const check of this._def.checks){
            if (check.kind === "min") {
                ...
                if (tooBig || tooSmall) {
                    ctx = this._getOrReturnCtx(input, ctx);
                    if (tooBig) $294e9db24f29f2d7$export$db7caee60e5d514d(ctx, {
                        code: $294e9db24f29f2d7$export$5ba560653e4a1035.too_big,
                        maximum: check.value,
                        type: "string",
                        inclusive: true,
                    ...
                    else if (tooSmall) $294e9db24f29f2d7$export$db7caee60e5d514d(ctx, {
                        code: $294e9db24f29f2d7$export$5ba560653e4a1035.too_small,
                        minimum: check.value,
                        type: "string",
                        inclusive: true,
                ...
                if (!$294e9db24f29f2d7$var$emojiRegex) $294e9db24f29f2d7$var$emojiRegex = new RegExp($294e9db24f29f2d7$var$_emojiRegex, "u");
    ...
    datetime(options) {
        ...
        return this._addCheck({
            ...
            ...$294e9db24f29f2d7$var$errorUtil.errToObj(options === null || options === void 0 ? void 0 : options.message)
        });
    }
    date(message) {
        return this._addCheck({
...
class $294e9db24f29f2d7$export$5b070a55c0c43e09 extends $294e9db24f29f2d7$export$19342e026b58ebb7 {
    ...
    get isInt() {
        return !!this._def.checks.find((ch)=>ch.kind === "int" || ch.kind === "multipleOf" && $294e9db24f29f2d7$export$7debb50ef11d5e0b.isInteger(ch.value));
    }
    get isFinite() {
...
class $294e9db24f29f2d7$export$7acfc3e64785411 extends $294e9db24f29f2d7$export$19342e026b58ebb7 {
    _parse(input) {
        ...
        if (def.exactLength !== null) {
            ...
            if (tooBig || tooSmall) {
                $294e9db24f29f2d7$export$db7caee60e5d514d(ctx, {
                    code: tooBig ? $294e9db24f29f2d7$export$5ba560653e4a1035.too_big : $294e9db24f29f2d7$export$5ba560653e4a1035.too_small,
        ...
        if (ctx.common.async) return Promise.all([
            ...
            return def.type._parseAsync(new $294e9db24f29f2d7$var$ParseInputLazyPath(ctx, item, ctx.path, i));
        })).then((result)=>{
        ...
        const result = [
            ...
            return def.type._parseSync(new $294e9db24f29f2d7$var$ParseInputLazyPath(ctx, item, ctx.path, i));
        });
        return $294e9db24f29f2d7$export$5b20a5c3d05c1f6f.mergeArray(status, result);
    }
    get element() {
...
function $294e9db24f29f2d7$var$deepPartialify(schema) {
    if (schema instanceof $294e9db24f29f2d7$export$736315c5b55efbad) {
        ...
        for(const key in schema.shape){
            ...
            newShape[key] = $294e9db24f29f2d7$export$aa56fec1e9d629b8.create($294e9db24f29f2d7$var$deepPartialify(fieldSchema));
        }
        return new $294e9db24f29f2d7$export$736315c5b55efbad({
            ...schema._def,
            shape: ()=>newShape
        });
    } else if (schema instanceof $294e9db24f29f2d7$export$7acfc3e64785411) return new $294e9db24f29f2d7$export$7acfc3e64785411({
        ...schema._def,
        type: $294e9db24f29f2d7$var$deepPartialify(schema.element)
    });
    else if (schema instanceof $294e9db24f29f2d7$export$aa56fec1e9d629b8) return $294e9db24f29f2d7$export$aa56fec1e9d629b8.create($294e9db24f29f2d7$var$deepPartialify(schema.unwrap()));
    else if (schema instanceof $294e9db24f29f2d7$export$aaac0b8b429cef5) return $294e9db24f29f2d7$export$aaac0b8b429cef5.create($294e9db24f29f2d7$var$deepPartialify(schema.unwrap()));
    else if (schema instanceof $294e9db24f29f2d7$export$e2a18bb771d8e6a3) return $294e9db24f29f2d7$export$e2a18bb771d8e6a3.create(schema.items.map((item)=>$294e9db24f29f2d7$var$deepPartialify(item)));
    else return schema;
}
class $294e9db24f29f2d7$export$736315c5b55efbad extends $294e9db24f29f2d7$export$19342e026b58ebb7 {
    ...
    _parse(input) {
        ...
        const extraKeys = [];
        if (!(this._def.catchall instanceof $294e9db24f29f2d7$export$1e576a20c3ce9fb5 && this._def.unknownKeys === "strip")) {
        ...
        for (const key of shapeKeys){
            ...
            pairs.push({
                ...
                value: keyValidator._parse(new $294e9db24f29f2d7$var$ParseInputLazyPath(ctx, value, ctx.path, key)),
        ...
        if (this._def.catchall instanceof $294e9db24f29f2d7$export$1e576a20c3ce9fb5) {
            ...
            for (const key of extraKeys){
                ...
                pairs.push({
                    ...
                    value: catchall._parse(new $294e9db24f29f2d7$var$ParseInputLazyPath(ctx, value, ctx.path, key) //, ctx.child(key), value, getParsedType(value)
                    ),
                    alwaysSet: key in ctx.data
                });
            }
            ...
            ...message !== undefined ? {
                errorMap: (issue, ctx)=>{
                    ...
                    if (issue.code === "unrecognized_keys") return {
                        message: (_d = $294e9db24f29f2d7$var$errorUtil.errToObj(message).message) !== null && _d !== void 0 ? _d : defaultError
                    };
                    return {
    ...
    required(mask) {
        ...
        $294e9db24f29f2d7$export$7debb50ef11d5e0b.objectKeys(this.shape).forEach((key)=>{
            if (mask && !mask[key]) newShape[key] = this.shape[key];
                ...
                while(newField instanceof $294e9db24f29f2d7$export$aa56fec1e9d629b8)newField = newField._def.innerType;
    ...
    keyof() {
        return $294e9db24f29f2d7$var$createZodEnum($294e9db24f29f2d7$export$7debb50ef11d5e0b.objectKeys(this.shape));
    }
}
...
class $294e9db24f29f2d7$export$a8b236cb5070a311 extends $294e9db24f29f2d7$export$19342e026b58ebb7 {
    _parse(input) {
        ...
        function handleResults(results) {
            ...
            // return invalid
            const unionErrors = results.map((result)=>new $294e9db24f29f2d7$export$f98dac4b251ab333(result.ctx.common.issues));
            $294e9db24f29f2d7$export$db7caee60e5d514d(ctx, {
        ...
        if (ctx.common.async) return Promise.all(options.map(async (option)=>{
            ...
            const unionErrors = issues.map((issues)=>new $294e9db24f29f2d7$export$f98dac4b251ab333(issues));
            $294e9db24f29f2d7$export$db7caee60e5d514d(ctx, {
                code: $294e9db24f29f2d7$export$5ba560653e4a1035.invalid_union,
                unionErrors: unionErrors
            });
...
const $294e9db24f29f2d7$var$getDiscriminator = (type)=>{
    if (type instanceof $294e9db24f29f2d7$export$378d0cfce37406e6) return $294e9db24f29f2d7$var$getDiscriminator(type.schema);
    else if (type instanceof $294e9db24f29f2d7$export$a60af00cc0ce2582) return $294e9db24f29f2d7$var$getDiscriminator(type.innerType());
    else if (type instanceof $294e9db24f29f2d7$export$7e44096782a165d3) return [
        type.value
    ];
    else if (type instanceof $294e9db24f29f2d7$export$d325d1f0e1c20179) return type.options;
    else if (type instanceof $294e9db24f29f2d7$export$370b2e8d6d6f5c56) // eslint-disable-next-line ban/ban
    return $294e9db24f29f2d7$export$7debb50ef11d5e0b.objectValues(type.enum);
    else if (type instanceof $294e9db24f29f2d7$export$bb19b37874861e7e) return $294e9db24f29f2d7$var$getDiscriminator(type._def.innerType);
    else if (type instanceof $294e9db24f29f2d7$export$4e780e961c30340d) return [
        undefined
    ];
    else if (type instanceof $294e9db24f29f2d7$export$a96281f914484f2d) return [
        null
    ];
    else if (type instanceof $294e9db24f29f2d7$export$aa56fec1e9d629b8) return [
        undefined,
        ...$294e9db24f29f2d7$var$getDiscriminator(type.unwrap())
    ];
    else if (type instanceof $294e9db24f29f2d7$export$aaac0b8b429cef5) return [
        null,
        ...$294e9db24f29f2d7$var$getDiscriminator(type.unwrap())
    ];
    else if (type instanceof $294e9db24f29f2d7$export$66b0c798a395271f) return $294e9db24f29f2d7$var$getDiscriminator(type.unwrap());
    else if (type instanceof $294e9db24f29f2d7$export$5d1f7ef05c4e493a) return $294e9db24f29f2d7$var$getDiscriminator(type.unwrap());
    else if (type instanceof $294e9db24f29f2d7$export$75a44ec6249ac76b) return $294e9db24f29f2d7$var$getDiscriminator(type._def.innerType);
    else return [];
};
...
function $294e9db24f29f2d7$var$mergeValues(a, b) {
    ...
    else if (aType === $294e9db24f29f2d7$export$5716da67bfaa244d.object && bType === $294e9db24f29f2d7$export$5716da67bfaa244d.object) {
        const bKeys = $294e9db24f29f2d7$export$7debb50ef11d5e0b.objectKeys(b);
        const sharedKeys = $294e9db24f29f2d7$export$7debb50ef11d5e0b.objectKeys(a).filter((key)=>bKeys.indexOf(key) !== -1);
        const newObj = {
            ...a,
            ...b
        };
    ...
    } else if (aType === $294e9db24f29f2d7$export$5716da67bfaa244d.array && bType === $294e9db24f29f2d7$export$5716da67bfaa244d.array) {
    ...
    } else if (aType === $294e9db24f29f2d7$export$5716da67bfaa244d.date && bType === $294e9db24f29f2d7$export$5716da67bfaa244d.date && +a === +b) return {
        valid: true,
        data: a
    };
    else return {
...
class $294e9db24f29f2d7$export$c02deaf0bb5203d4 extends $294e9db24f29f2d7$export$19342e026b58ebb7 {
    _parse(input) {
        ...
        const handleParsed = (parsedLeft, parsedRight)=>{
            if ($294e9db24f29f2d7$export$afa861e3c5730743(parsedLeft) || $294e9db24f29f2d7$export$afa861e3c5730743(parsedRight)) return $294e9db24f29f2d7$export$9a105a556e65c2c0;
            ...
            if ($294e9db24f29f2d7$export$910b6cdd390341b3(parsedLeft) || $294e9db24f29f2d7$export$910b6cdd390341b3(parsedRight)) status.dirty();
            return {
                status: status.value,
                value: merged.data
            };
...
class $294e9db24f29f2d7$export$e2a18bb771d8e6a3 extends $294e9db24f29f2d7$export$19342e026b58ebb7 {
    _parse(input) {
        ...
        const items = [
            ...
            return schema._parse(new $294e9db24f29f2d7$var$ParseInputLazyPath(ctx, item, ctx.path, itemIndex));
...
class $294e9db24f29f2d7$export$a2acc09968cb4b7f extends $294e9db24f29f2d7$export$19342e026b58ebb7 {
    ...
    _parse(input) {
        ...
        for(const key in ctx.data)pairs.push({
            ...
            value: valueType._parse(new $294e9db24f29f2d7$var$ParseInputLazyPath(ctx, ctx.data[key], ctx.path, key)),
            alwaysSet: key in ctx.data
        });
        if (ctx.common.async) return $294e9db24f29f2d7$export$5b20a5c3d05c1f6f.mergeObjectAsync(status, pairs);
        else return $294e9db24f29f2d7$export$5b20a5c3d05c1f6f.mergeObjectSync(status, pairs);
    }
    get element() {
        return this._def.valueType;
    ...
    static create(first, second, third) {
        if (second instanceof $294e9db24f29f2d7$export$19342e026b58ebb7) return new $294e9db24f29f2d7$export$a2acc09968cb4b7f({
            keyType: first,
            valueType: second,
...
class $294e9db24f29f2d7$export$163b6a2b712d9542 extends $294e9db24f29f2d7$export$19342e026b58ebb7 {
    ...
    _parse(input) {
        ...
        const pairs = [
            ...
            return {
                key: keyType._parse(new $294e9db24f29f2d7$var$ParseInputLazyPath(ctx, key, ctx.path, [
                    index,
                    "key"
                ])),
                value: valueType._parse(new $294e9db24f29f2d7$var$ParseInputLazyPath(ctx, value, ctx.path, [
                    index,
                    "value"
                ]))
            };
        ...
        if (ctx.common.async) {
            ...
            return Promise.resolve().then(async ()=>{
                for (const pair of pairs){
                    const key = await pair.key;
                    const value = await pair.value;
                    if (key.status === "aborted" || value.status === "aborted") return $294e9db24f29f2d7$export$9a105a556e65c2c0;
...
class $294e9db24f29f2d7$export$977057706f816712 extends $294e9db24f29f2d7$export$19342e026b58ebb7 {
    _parse(input) {
        ...
        const elements = [
            ...ctx.data.values()
        ].map((item, i)=>valueType._parse(new $294e9db24f29f2d7$var$ParseInputLazyPath(ctx, item, ctx.path, i)));
...
class $294e9db24f29f2d7$export$d4602ba55673f53c extends $294e9db24f29f2d7$export$19342e026b58ebb7 {
    ...
    _parse(input) {
        ...
        if (this._def.returns instanceof $294e9db24f29f2d7$export$3f196b0127d6e50a) {
            ...
            return $294e9db24f29f2d7$export$c6813a8d51f77eaf(function(...args) {
                ...
                if (!parsedArgs.success) throw new $294e9db24f29f2d7$export$f98dac4b251ab333([
                    makeArgsIssue(args, parsedArgs.error)
                ]);
                const result = Reflect.apply(fn, this, parsedArgs.data);
                const parsedReturns = me._def.returns.safeParse(result, params);
                if (!parsedReturns.success) throw new $294e9db24f29f2d7$export$f98dac4b251ab333([
    ...
    args(...items) {
        return new $294e9db24f29f2d7$export$d4602ba55673f53c({
            ...this._def,
            args: $294e9db24f29f2d7$export$e2a18bb771d8e6a3.create(items).rest($294e9db24f29f2d7$export$ef3b1bb1630977ae.create())
        });
    }
    returns(returnType) {
        return new $294e9db24f29f2d7$export$d4602ba55673f53c({
    ...
    static create(args, returns, params) {
        return new $294e9db24f29f2d7$export$d4602ba55673f53c({
            args: args ? args : $294e9db24f29f2d7$export$e2a18bb771d8e6a3.create([]).rest($294e9db24f29f2d7$export$ef3b1bb1630977ae.create()),
...
class $294e9db24f29f2d7$export$d325d1f0e1c20179 extends $294e9db24f29f2d7$export$19342e026b58ebb7 {
    ...
    _parse(input) {
        ...
        if (!$294e9db24f29f2d7$var$__classPrivateFieldGet(this, $294e9db24f29f2d7$var$_ZodEnum_cache, "f")) $294e9db24f29f2d7$var$__classPrivateFieldSet(this, $294e9db24f29f2d7$var$_ZodEnum_cache, new Set(this._def.values), "f");
        if (!$294e9db24f29f2d7$var$__classPrivateFieldGet(this, $294e9db24f29f2d7$var$_ZodEnum_cache, "f").has(input.data)) {
            const ctx = this._getOrReturnCtx(input);
            const expectedValues = this._def.values;
            $294e9db24f29f2d7$export$db7caee60e5d514d(ctx, {
                received: ctx.data,
    ...
    exclude(values, newDef = this._def) {
        return $294e9db24f29f2d7$export$d325d1f0e1c20179.create(this.options.filter((opt)=>!values.includes(opt)), {
            ...this._def,
            ...newDef
        });
    }
...
class $294e9db24f29f2d7$export$370b2e8d6d6f5c56 extends $294e9db24f29f2d7$export$19342e026b58ebb7 {
    ...
    _parse(input) {
        const nativeEnumValues = $294e9db24f29f2d7$export$7debb50ef11d5e0b.getValidEnumValues(this._def.values);
        const ctx = this._getOrReturnCtx(input);
        if (ctx.parsedType !== $294e9db24f29f2d7$export$5716da67bfaa244d.string && ctx.parsedType !== $294e9db24f29f2d7$export$5716da67bfaa244d.number) {
            const expectedValues = $294e9db24f29f2d7$export$7debb50ef11d5e0b.objectValues(nativeEnumValues);
            $294e9db24f29f2d7$export$db7caee60e5d514d(ctx, {
                expected: $294e9db24f29f2d7$export$7debb50ef11d5e0b.joinValues(expectedValues),
                received: ctx.parsedType,
                code: $294e9db24f29f2d7$export$5ba560653e4a1035.invalid_type
        ...
        if (!$294e9db24f29f2d7$var$__classPrivateFieldGet(this, $294e9db24f29f2d7$var$_ZodNativeEnum_cache, "f")) $294e9db24f29f2d7$var$__classPrivateFieldSet(this, $294e9db24f29f2d7$var$_ZodNativeEnum_cache, new Set($294e9db24f29f2d7$export$7debb50ef11d5e0b.getValidEnumValues(this._def.values)), "f");
        if (!$294e9db24f29f2d7$var$__classPrivateFieldGet(this, $294e9db24f29f2d7$var$_ZodNativeEnum_cache, "f").has(input.data)) {
            const expectedValues = $294e9db24f29f2d7$export$7debb50ef11d5e0b.objectValues(nativeEnumValues);
            $294e9db24f29f2d7$export$db7caee60e5d514d(ctx, {
                received: ctx.data,
                code: $294e9db24f29f2d7$export$5ba560653e4a1035.invalid_enum_value,
...
class $294e9db24f29f2d7$export$3f196b0127d6e50a extends $294e9db24f29f2d7$export$19342e026b58ebb7 {
    ...
    _parse(input) {
        const { ctx: ctx } = this._processInputParams(input);
        if (ctx.parsedType !== $294e9db24f29f2d7$export$5716da67bfaa244d.promise && ctx.common.async === false) {
            $294e9db24f29f2d7$export$db7caee60e5d514d(ctx, {
                code: $294e9db24f29f2d7$export$5ba560653e4a1035.invalid_type,
        ...
        const promisified = ctx.parsedType === $294e9db24f29f2d7$export$5716da67bfaa244d.promise ? ctx.data : Promise.resolve(ctx.data);
        return $294e9db24f29f2d7$export$c6813a8d51f77eaf(promisified.then((data)=>{
...
class $294e9db24f29f2d7$export$a60af00cc0ce2582 extends $294e9db24f29f2d7$export$19342e026b58ebb7 {
    ...
    sourceType() {
        return this._def.schema._def.typeName === $294e9db24f29f2d7$export$558106ce543bd011.ZodEffects ? this._def.schema.sourceType() : this._def.schema;
    }
    _parse(input) {
        const { status: status, ctx: ctx } = this._processInputParams(input);
        ...
        if (effect.type === "preprocess") {
            ...
            if (ctx.common.async) return Promise.resolve(processed).then(async (processed)=>{
                ...
                if (result.status === "dirty") return $294e9db24f29f2d7$export$325a211da9693fcf(result.value);
                if (status.value === "dirty") return $294e9db24f29f2d7$export$325a211da9693fcf(result.value);
                return result;
            });
            else {
                if (status.value === "aborted") return $294e9db24f29f2d7$export$9a105a556e65c2c0;
...
class $294e9db24f29f2d7$export$aa56fec1e9d629b8 extends $294e9db24f29f2d7$export$19342e026b58ebb7 {
    _parse(input) {
        const parsedType = this._getType(input);
        if (parsedType === $294e9db24f29f2d7$export$5716da67bfaa244d.undefined) return $294e9db24f29f2d7$export$c6813a8d51f77eaf(undefined);
...
class $294e9db24f29f2d7$export$aaac0b8b429cef5 extends $294e9db24f29f2d7$export$19342e026b58ebb7 {
    _parse(input) {
        const parsedType = this._getType(input);
        if (parsedType === $294e9db24f29f2d7$export$5716da67bfaa244d.null) return $294e9db24f29f2d7$export$c6813a8d51f77eaf(null);
        return this._def.innerType._parse(input);
    }
    unwrap() {
        return this._def.innerType;
...
class $294e9db24f29f2d7$export$bb19b37874861e7e extends $294e9db24f29f2d7$export$19342e026b58ebb7 {
    _parse(input) {
        const { ctx: ctx } = this._processInputParams(input);
        let data = ctx.data;
        if (ctx.parsedType === $294e9db24f29f2d7$export$5716da67bfaa244d.undefined) data = this._def.defaultValue();
...
class $294e9db24f29f2d7$export$75a44ec6249ac76b extends $294e9db24f29f2d7$export$19342e026b58ebb7 {
    _parse(input) {
        ...
        if ($294e9db24f29f2d7$export$aefee5ebe1dcfd9e(result)) return result.then((result)=>{
            return {
                status: "valid",
...
class $294e9db24f29f2d7$export$5d1f7ef05c4e493a extends $294e9db24f29f2d7$export$19342e026b58ebb7 {
    _parse(input) {
        ...
        return $294e9db24f29f2d7$export$aefee5ebe1dcfd9e(result) ? result.then((data)=>freeze(data)) : freeze(result);
    }
    unwrap() {
        return this._def.innerType;
    }
...
function $294e9db24f29f2d7$export$4c00f665f0d4b443(check, params = {}, /**
 * @deprecated
 *
 ...
 *
 */ fatal) {
    if (check) return $294e9db24f29f2d7$export$b9d1edb536b4e4eb.create().superRefine((data, ctx)=>{
        var _a, _b;
        if (!check(data)) {
...
const $294e9db24f29f2d7$export$3d916e7c22dbd8b5 = (// const instanceOfType = <T extends new (...args: any[]) => any>(
cls, params = {
...
const $294e9db24f29f2d7$export$8fb0df5f40d0b477 = $294e9db24f29f2d7$export$736315c5b55efbad.strictCreate;
...
const $294e9db24f29f2d7$export$fc37fe19dfda43ee = $294e9db24f29f2d7$export$a60af00cc0ce2582.createWithPreprocess;
const $294e9db24f29f2d7$export$43f28b24e1eb8181 = $294e9db24f29f2d7$export$a3c3ef8a0e95c6da.create;
const $294e9db24f29f2d7$export$3b3d07727c5b702c = ()=>$294e9db24f29f2d7$export$22b082955e083ec3().optional();
const $294e9db24f29f2d7$export$eb150471a61fced6 = ()=>$294e9db24f29f2d7$export$98e628dec113755e().optional();
const $294e9db24f29f2d7$export$269251733cdcbbf1 = ()=>$294e9db24f29f2d7$export$4a21f16c33752377().optional();
const $294e9db24f29f2d7$export$8c14e57e778d3873 = {
    string: (arg)=>$294e9db24f29f2d7$export$1230eb29b8d3b502.create({
            ...arg,
            coerce: true
        }),
    number: (arg)=>$294e9db24f29f2d7$export$5b070a55c0c43e09.create({
            ...arg,
            coerce: true
        }),
    boolean: (arg)=>$294e9db24f29f2d7$export$723d146f80596191.create({
            ...arg,
            coerce: true
        }),
    bigint: (arg)=>$294e9db24f29f2d7$export$67d741fd70ff98f4.create({
            ...arg,
            coerce: true
        }),
    date: (arg)=>$294e9db24f29f2d7$export$e974be33bdc55521.create({
            ...arg,
            coerce: true
        })
};
...
function $4d4d71f7d5249f02$export$9c1a0c7a7667fa87(def, refs) {
    ...
    if (def.type?._def?.typeName !== (0, $294e9db24f29f2d7$export$558106ce543bd011).ZodAny) res.items = (0, $fbd16001e3410077$export$1063952312e3541c)(def.type._def, {
        ...refs,
        currentPath: [
            ...refs.currentPath,
            "items"
    ...
    if (def.minLength) (0, $018f6204717062ca$export$f7d2bce693b08d40)(res, "minItems", def.minLength.value, def.minLength.message, refs);
    if (def.maxLength) (0, $018f6204717062ca$export$f7d2bce693b08d40)(res, "maxItems", def.maxLength.value, def.maxLength.message, refs);
    if (def.exactLength) {
        (0, $018f6204717062ca$export$f7d2bce693b08d40)(res, "minItems", def.exactLength.value, def.exactLength.message, refs);
        (0, $018f6204717062ca$export$f7d2bce693b08d40)(res, "maxItems", def.exactLength.value, def.exactLength.message, refs);
    }
    return res;
}
    ...
    for (const check of def.checks)switch(check.kind){
        case "min":
            if (refs.target === "jsonSchema7") {
                if (check.inclusive) (0, $018f6204717062ca$export$f7d2bce693b08d40)(res, "minimum", check.value, check.message, refs);
                else (0, $018f6204717062ca$export$f7d2bce693b08d40)(res, "exclusiveMinimum", check.value, check.message, refs);
            } else {
                if (!check.inclusive) res.exclusiveMinimum = true;
                (0, $018f6204717062ca$export$f7d2bce693b08d40)(res, "minimum", check.value, check.message, refs);
            }
            break;
        case "max":
            if (refs.target === "jsonSchema7") {
                if (check.inclusive) (0, $018f6204717062ca$export$f7d2bce693b08d40)(res, "maximum", check.value, check.message, refs);
                else (0, $018f6204717062ca$export$f7d2bce693b08d40)(res, "exclusiveMaximum", check.value, check.message, refs);
            } else {
                if (!check.inclusive) res.exclusiveMaximum = true;
                (0, $018f6204717062ca$export$f7d2bce693b08d40)(res, "maximum", check.value, check.message, refs);
            }
            break;
        case "multipleOf":
            (0, $018f6204717062ca$export$f7d2bce693b08d40)(res, "multipleOf", check.value, check.message, refs);
            break;
    }
    return res;
}
...
function $7b40b3d7c271f24f$export$8edd16d8c2901277(_def, refs, forceResolution) {
    return refs.effectStrategy === "input" ? (0, $fbd16001e3410077$export$1063952312e3541c)(_def.schema._def, refs, forceResolution) : {};
}
...
const $84db91251c86581b$export$999ee5d51ef74217 = {
     ...
     */ emoji: ()=>{
        if ($84db91251c86581b$var$emojiRegex === undefined) $84db91251c86581b$var$emojiRegex = RegExp("^(\\p{Extended_Pictographic}|\\p{Emoji_Component})+$", "u");
...
function $84db91251c86581b$export$c6dca604104d35ca(def, refs) {
    ...
    function processPattern(value) {
        return refs.patternStrategy === "escape" ? $84db91251c86581b$var$escapeNonAlphaNumeric(value) : value;
    }
    if (def.checks) for (const check of def.checks)switch(check.kind){
        case "min":
            (0, $018f6204717062ca$export$f7d2bce693b08d40)(res, "minLength", typeof res.minLength === "number" ? Math.max(res.minLength, check.value) : check.value, check.message, refs);
            break;
        case "max":
            (0, $018f6204717062ca$export$f7d2bce693b08d40)(res, "maxLength", typeof res.maxLength === "number" ? Math.min(res.maxLength, check.value) : check.value, check.message, refs);
            break;
        case "email":
            switch(refs.emailStrategy){
                ...
                case "format:idn-email":
                    ...
                    break;
                case "pattern:zod":
                    $84db91251c86581b$var$addPattern(res, $84db91251c86581b$export$999ee5d51ef74217.email, check.message, refs);
                    break;
            }
            break;
        case "url":
        ...
        case "regex":
            ...
            break;
        case "cuid":
            $84db91251c86581b$var$addPattern(res, $84db91251c86581b$export$999ee5d51ef74217.cuid, check.message, refs);
            break;
        case "cuid2":
            $84db91251c86581b$var$addPattern(res, $84db91251c86581b$export$999ee5d51ef74217.cuid2, check.message, refs);
            break;
        case "startsWith":
            $84db91251c86581b$var$addPattern(res, RegExp(`^${processPattern(check.value)}`), check.message, refs);
            break;
        case "endsWith":
            $84db91251c86581b$var$addPattern(res, RegExp(`${processPattern(check.value)}$`), check.message, refs);
            break;
        ...
        case "includes":
            ...
            break;
        case "ip":
            if (check.version !== "v6") $84db91251c86581b$var$addFormat(res, "ipv4", check.message, refs);
            if (check.version !== "v4") $84db91251c86581b$var$addFormat(res, "ipv6", check.message, refs);
            break;
        case "emoji":
            $84db91251c86581b$var$addPattern(res, $84db91251c86581b$export$999ee5d51ef74217.emoji, check.message, refs);
            break;
        case "ulid":
            $84db91251c86581b$var$addPattern(res, $84db91251c86581b$export$999ee5d51ef74217.ulid, check.message, refs);
            break;
        case "base64":
            switch(refs.base64Strategy){
                ...
                case "contentEncoding:base64":
                    (0, $018f6204717062ca$export$f7d2bce693b08d40)(res, "contentEncoding", "base64", check.message, refs);
                    break;
                case "pattern:zod":
                    $84db91251c86581b$var$addPattern(res, $84db91251c86581b$export$999ee5d51ef74217.base64, check.message, refs);
                    break;
            }
            break;
        case "nanoid":
            $84db91251c86581b$var$addPattern(res, $84db91251c86581b$export$999ee5d51ef74217.nanoid, check.message, refs);
        case "toLowerCase":
        case "toUpperCase":
        case "trim":
            break;
...
const $84db91251c86581b$var$escapeNonAlphaNumeric = (value)=>Array.from(value).map((c)=>/[a-zA-Z0-9]/.test(c) ? c : `\\${c}`).join("");
...
const $84db91251c86581b$var$addPattern = (schema, regex, message, refs)=>{
    ...
    } else (0, $018f6204717062ca$export$f7d2bce693b08d40)(schema, "pattern", $84db91251c86581b$var$processRegExp(regex, refs), message, refs);
};
...
function $2377d57d2a0bc2b5$export$bab91a30f81817bc(def, refs) {
    if (refs.target === "openApi3" && def.keyType?._def.typeName === (0, $294e9db24f29f2d7$export$558106ce543bd011).ZodEnum) return {
        type: "object",
        required: def.keyType._def.values,
        properties: def.keyType._def.values.reduce((acc, key)=>({
                ...acc,
                [key]: (0, $fbd16001e3410077$export$1063952312e3541c)(def.valueType._def, {
                    ...refs,
                    currentPath: [
                        ...refs.currentPath,
                        "properties",
    ...
    const schema = {
        type: "object",
        additionalProperties: (0, $fbd16001e3410077$export$1063952312e3541c)(def.valueType._def, {
            ...refs,
            currentPath: [
                ...refs.currentPath,
    ...
    if (def.keyType?._def.typeName === (0, $294e9db24f29f2d7$export$558106ce543bd011).ZodString && def.keyType._def.checks?.length) {
        const keyType = Object.entries((0, $84db91251c86581b$export$c6dca604104d35ca)(def.keyType._def, refs)).reduce((acc, [key, value])=>key === "type" ? acc : {
                ...acc,
                [key]: value
            }, {});
        return {
    ...
    } else if (def.keyType?._def.typeName === (0, $294e9db24f29f2d7$export$558106ce543bd011).ZodEnum) return {
        ...schema,
        propertyNames: {
...
function $9009062089b1ff0d$export$cb8e42ab369177cd(def, refs) {
    if (refs.mapStrategy === "record") return (0, $2377d57d2a0bc2b5$export$bab91a30f81817bc)(def, refs);
    const keys = (0, $fbd16001e3410077$export$1063952312e3541c)(def.keyType._def, {
        ...refs,
        currentPath: [
            ...refs.currentPath,
            "items",
    ...
    const values = (0, $fbd16001e3410077$export$1063952312e3541c)(def.valueType._def, {
        ...refs,
        currentPath: [
            ...refs.currentPath,
            "items",
...
function $aa2ed10a7ffdbca6$export$4fd6ebd75521f86f(def, refs) {
    ...
    if (options.every((x)=>x._def.typeName in $aa2ed10a7ffdbca6$export$53d0c9700414d70b && (!x._def.checks || !x._def.checks.length))) {
...
const $aa2ed10a7ffdbca6$var$asAnyOf = (def, refs)=>{
    const anyOf = (def.options instanceof Map ? Array.from(def.options.values()) : def.options).map((x, i)=>(0, $fbd16001e3410077$export$1063952312e3541c)(x._def, {
            ...refs,
            currentPath: [
                ...refs.currentPath,
                "anyOf",
...
function $59743c9f8262b370$export$5b998cd3cbcce402(def, refs) {
    if ([
        ...
        return {
            type: [
                (0, $aa2ed10a7ffdbca6$export$53d0c9700414d70b)[def.innerType._def.typeName],
                "null"
            ]
        };
    }
...
function $23e8ff4b993666e1$var$decideAdditionalProperties(def, refs) {
    if (refs.removeAdditionalStrategy === "strict") return def.catchall._def.typeName === "ZodNever" ? def.unknownKeys !== "strict" : (0, $fbd16001e3410077$export$1063952312e3541c)(def.catchall._def, {
        ...refs,
        currentPath: [
            ...refs.currentPath,
            "additionalProperties"
    ...
    else return def.catchall._def.typeName === "ZodNever" ? def.unknownKeys === "passthrough" : (0, $fbd16001e3410077$export$1063952312e3541c)(def.catchall._def, {
        ...refs,
        currentPath: [
            ...refs.currentPath,
            "additionalProperties"
...
const $5e7f249f5124e5c9$export$9ebda48a78f86524 = (def, refs)=>{
    if (refs.currentPath.toString() === refs.propertyPath?.toString()) return (0, $fbd16001e3410077$export$1063952312e3541c)(def.innerType._def, refs);
...
const $245c841504273f27$export$c5b6cc918b779721 = (def, refs)=>{
    if (refs.pipeStrategy === "input") return (0, $fbd16001e3410077$export$1063952312e3541c)(def.in._def, refs);
    else if (refs.pipeStrategy === "output") return (0, $fbd16001e3410077$export$1063952312e3541c)(def.out._def, refs);
...
function $f0a06d2d6c843c21$export$9bf814691104eb22(def, refs) {
    ...
    if (def.minSize) (0, $018f6204717062ca$export$f7d2bce693b08d40)(schema, "minItems", def.minSize.value, def.minSize.message, refs);
    if (def.maxSize) (0, $018f6204717062ca$export$f7d2bce693b08d40)(schema, "maxItems", def.maxSize.value, def.maxSize.message, refs);
    return schema;
}
...
function $58fdc5cd924dfb4a$export$49b44f845e795a29(def, refs) {
    if (def.rest) return {
        ...
        items: def.items.map((x, i)=>(0, $fbd16001e3410077$export$1063952312e3541c)(x._def, {
                ...refs,
                currentPath: [
                    ...refs.currentPath,
                    "items",
...
const $de802e4b2e6f3e6c$export$c23321d057eaf8c4 = Symbol("Let zodToJsonSchema decide on which parser to use");
...
const $b268a68eb3327929$export$c365928c26d2ef43 = (schema, options)=>{
    ...
    const main = (0, $fbd16001e3410077$export$1063952312e3541c)(schema._def, name === undefined ? refs : {
        ...refs,
        currentPath: [
            ...refs.basePath,
            refs.definitionPath,
    ...
    const definitions = (()=>{
        ...
        for(let i = 0; i < 500; i++){
            ...
            for (const [key, schema] of newDefinitions){
                definitions[key] = (0, $fbd16001e3410077$export$1063952312e3541c)((0, $fa9fa96edd434825$export$57f91ba833ce5030)(schema), {
                    ...refs,
                    currentPath: [
                        ...refs.basePath,
                        refs.definitionPath,
...
class $c3ee996f8adac281$export$eb017f9453374fe1 {
    ...
    /** Used to strongly typed parse user answer for getting their name and age */ PatientDataResponse = (0, $294e9db24f29f2d7$export$2e2bcd8739ae039).object({
   ...
   */ async getPatientData(messages) {
        const params = {
            ...
            response_format: (0, $270574008f92c4d9$export$5a36c27dc294dc58)(this.PatientDataResponse, "data")
        };
