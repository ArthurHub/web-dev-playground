...
var require_string_width = __commonJS({
  "../../node_modules/@inquirer/core/node_modules/string-width/index.js"(exports, module) {
    "use strict";
...
var require_unicode = __commonJS({
  "../../node_modules/chardet/encoding/unicode.js"(exports, module) {
    "use strict";
    var util = __require("util"), Match = require_match();
...
var require_chardet = __commonJS({
  "../../node_modules/chardet/index.js"(exports, module) {
    ...
    var utf8 = require_utf8(), unicode = require_unicode(), mbcs = require_mbcs(), sbcs = require_sbcs(), iso2022 = require_iso2022();
    var self = exports;
    var recognisers = [
      new utf8(),
    ...
    module.exports.detectFileSync = function(filepath, opts) {
      ...
      return self.detect(fs4.readFileSync(filepath), opts);
    };
...
var require_streams = __commonJS({
  "../../node_modules/iconv-lite/lib/streams.js"(exports, module) {
    "use strict";
    var Buffer2 = __require("buffer").Buffer, Transform = __require("stream").Transform;
...
var logger3 = getLogger("cmd-interface");
...
async function executeFixOption(option, folderPath, isDryRun) {
  if (option === 0 /* FixFileNames */) {
    ...
    logger3.info(`Performing Option B on file: ${folderPath}`);
  }
}
async function getUserChoice() {
  return await esm_default11({
    ...
    choices: [
      { name: "Fix OneDrive media file names", value: 0 /* FixFileNames */ },
      { name: "Convert HEIC photos to JPEG", value: 1 /* ConvertHEICtoJPEG */ },
      { name: "Exit", value: 2 /* Exit */ }
    ]
  });
}
async function promptForFolderPath() {
  let folderPath = "";
  const data = readData();
  if (data.lastUsedPaths.length) {
    const choices = data.lastUsedPaths.map((path3) => ({ name: path3, value: path3 }));
    choices.push({ name: "Other", value: "" });
    folderPath = await esm_default11({
  ...
  if (!folderPath || !fs3.existsSync(folderPath)) {
    folderPath = await esm_default5({
      ...
      validate: (inputValue) => {
        return fs3.existsSync(inputValue) ? true : "The specified file path does not exist.";
      }
    });
  }
...
async function runOneDriveNameDateFixer(filePath, isDryRun) {
  try {
    logger3.info(`Run fix media files names in: "${filePath}"`);
...
-------------`,
    ...
    logger3.fatal(error, "Failed running OneDrive name date fixer");
  }
}
function getCounts(handledFiles) {
  let updated = 0;
  ...
  for (const file of handledFiles) {
    if (file.status === "UPDATED" /* Updated */) {
      ...
      noUpdateRequired++;
    } else if (file.status === "SKIPPED_NOT_IPHONE" /* SkippedNotIPhone */) {
      skippedNotIPhone++;
    }
  }
...
function readData() {
  if (!fs3.existsSync(onedriveFixerDataFile)) {
    return { lastUsedPaths: [] };
  }
  const data = fs3.readFileSync(onedriveFixerDataFile, "utf-8");
  return JSON.parse(data);
}
function writeData(data, folderPath) {
  ...
  fs3.writeFileSync(onedriveFixerDataFile, JSON.stringify(data, null, 2));
}
